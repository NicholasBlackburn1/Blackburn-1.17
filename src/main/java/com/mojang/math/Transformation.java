...
public final class Transformation
{
    ...
    public Transformation compose(Transformation pMatrix)
    {
    ...
    private static Matrix4f compose(@Nullable Vector3f p_121099_, @Nullable Quaternion pMatrix, @Nullable Vector3f p_121101_, @Nullable Quaternion p_121102_)
    {
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.setIdentity();
        ...
        if (pMatrix != null)
        {
            matrix4f.multiply(new Matrix4f(pMatrix));
        }

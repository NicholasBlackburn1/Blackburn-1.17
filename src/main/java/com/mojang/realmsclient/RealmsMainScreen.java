...
public class RealmsMainScreen extends RealmsScreen {
   ...
   public void render(PoseStack p_86413_, int p_86414_, int p_86415_, float p_86416_) {
      ...
      if (this.shouldShowPopup()) {
         this.drawPopup(p_86413_, p_86414_, p_86415_);
      } else {
      ...
      if (this.trialsAvailable && !this.createdTrial && this.shouldShowPopup()) {
         ...
         GuiComponent.blit(p_86413_, this.createTrialButton.x + this.createTrialButton.getWidth() - 8 - 4, this.createTrialButton.y + this.createTrialButton.getHeight() / 2 - 4, 0.0F, (float)j, 8, 8, 8, 16);
      }
   ...
   class NewsButton extends Button {
      ...
      public void renderButton(PoseStack p_86806_, int p_86807_, int p_86808_, float p_86809_) {
         RealmsMainScreen.this.renderNews(p_86806_, p_86807_, p_86808_, RealmsMainScreen.this.hasUnreadNews, this.x, this.y, this.isHovered(), this.active);
      }
   }
   ...
   class PendingInvitesButton extends Button {
      ...
      public void renderButton(PoseStack p_86817_, int p_86818_, int p_86819_, float p_86820_) {
         RealmsMainScreen.this.drawInvitationPendingIcon(p_86817_, p_86818_, p_86819_, this.x, this.y, this.isHovered(), this.active);
      }
   }
   ...
   class RealmSelectionList extends RealmsObjectSelectionList<RealmsMainScreen.Entry> {
      ...
      public void setSelected(@Nullable RealmsMainScreen.Entry p_86849_) {
         ...
         int i = this.children().indexOf(p_86849_) - (this.showingMessage ? 1 : 0);
   ...
   class ShowPopupButton extends Button {
      ...
      public void renderButton(PoseStack p_86899_, int p_86900_, int p_86901_, float p_86902_) {
         RealmsMainScreen.this.renderMoreInfo(p_86899_, p_86900_, p_86901_, this.x, this.y, this.isHovered());
      }
   }

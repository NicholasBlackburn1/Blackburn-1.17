...
public class RealmsMainScreen extends RealmsScreen
{
    ...
    void leaveClicked(@Nullable RealmsServer p_86670_)
    {
        if (p_86670_ != null && !this.minecraft.getUser().getUuid().equals(p_86670_.ownerUUID))
        {
            ...
            this.minecraft.setScreen(new RealmsLongConfirmationScreen(this::leaveServer, RealmsLongConfirmationScreen.Type.Info, component, component1, true));
        }
    }
    ...
    @Nullable
    RealmsServer findServer(long p_86405_)
    {
        for (RealmsServer realmsserver : this.realmsServers)
        {
            if (realmsserver.id == p_86405_)
            {
                return realmsserver;
            }
        }
    ...
    private void leaveServer(boolean p_86624_)
    {
        if (p_86624_)
        {
            final long i = this.selectedServerId;
            (new Thread("Realms-leave-server")
            {
                public void run()
                {
                    try
                    {
                        RealmsServer realmsserver = RealmsMainScreen.this.findServer(i);
    ...
    {
        REALMS_DATA_FETCHER.removeItem(p_86677_);
        this.realmsServers.remove(p_86677_);
        this.realmSelectionList.children().removeIf((p_86447_) ->
        {
            return p_86447_ instanceof RealmsMainScreen.ServerEntry && ((RealmsMainScreen.ServerEntry)p_86447_).serverData.id == this.selectedServerId;
        });
    ...
    {
        this.keyCombos.forEach((p_86392_) ->
        {
            p_86392_.keyPressed(pCodePoint);
        });
        return true;
    }
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        this.realmSelectionList.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        this.drawRealmsLogo(pMatrixStack, this.width / 2 - 50, 7);

        if (RealmsClient.currentEnvironment == RealmsClient.Environment.STAGE)
        {
            this.renderStage(pMatrixStack);
        }

        if (RealmsClient.currentEnvironment == RealmsClient.Environment.LOCAL)
        {
            this.renderLocal(pMatrixStack);
        }

        if (this.shouldShowPopup())
        {
            this.drawPopup(pMatrixStack, pMouseX, pMouseY);
        }
        else
        {
        ...
        if (this.trialsAvailable && !this.createdTrial && this.shouldShowPopup())
        {
            ...
            GuiComponent.blit(pMatrixStack, this.createTrialButton.x + this.createTrialButton.getWidth() - 8 - 4, this.createTrialButton.y + this.createTrialButton.getHeight() / 2 - 4, 0.0F, (float)j, 8, 8, 8, 16);
        }
    }
    ...
    private void drawPopup(PoseStack p_86534_, int p_86535_, int p_86536_)
    {
        ...
        int k = 0;
        int l = 32;
        GuiComponent.blit(p_86534_, 0, 32, 0.0F, 0.0F, this.width, this.height - 40 - 32, 310, 166);
        RenderSystem.disableBlend();
        RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
        RenderSystem.setShaderTexture(0, POPUP_LOCATION);
        GuiComponent.blit(p_86534_, i, j, 0.0F, 0.0F, 310, 166, 310, 166);

        if (!teaserImages.isEmpty())
        {
            RenderSystem.setShaderTexture(0, teaserImages.get(this.carouselIndex));
            RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
            GuiComponent.blit(p_86534_, i + 7, j + 7, 0.0F, 0.0F, 195, 152, 195, 152);
        ...
        this.formattedPopup.renderLeftAlignedNoShadow(p_86534_, this.width / 2 + 52, j + 7, 10, 5000268);
    }
    ...
    void drawExpired(PoseStack p_86577_, int p_86578_, int p_86579_, int p_86580_, int p_86581_)
    {
        ...
        {
            this.m_86526_(SERVER_EXPIRED_TOOLTIP);
        }
    }
    ...
    void drawExpiring(PoseStack p_86538_, int p_86539_, int p_86540_, int p_86541_, int p_86542_, int p_86543_)
    {
        ...
        if (p_86541_ >= p_86539_ && p_86541_ <= p_86539_ + 9 && p_86542_ >= p_86540_ && p_86542_ <= p_86540_ + 27 && p_86542_ < this.height - 40 && p_86542_ > 32 && !this.shouldShowPopup())
        {
            if (p_86543_ <= 0)
            {
                this.m_86526_(SERVER_EXPIRES_SOON_TOOLTIP);
            }
            else if (p_86543_ == 1)
            {
                this.m_86526_(SERVER_EXPIRES_IN_DAY_TOOLTIP);
            }
            else
            {
    ...
    void drawOpen(PoseStack p_86602_, int p_86603_, int p_86604_, int p_86605_, int p_86606_)
    {
        ...
        {
            this.m_86526_(SERVER_OPEN_TOOLTIP);
        }
    }
    ...
    void drawClose(PoseStack p_86627_, int p_86628_, int p_86629_, int p_86630_, int p_86631_)
    {
        ...
        {
            this.m_86526_(SERVER_CLOSED_TOOLTIP);
        }
    }
    ...
    void drawLeave(PoseStack p_86649_, int p_86650_, int p_86651_, int p_86652_, int p_86653_)
    {
        ...
        if (flag)
        {
            this.m_86526_(LEAVE_SERVER_TOOLTIP);
    ...
    void drawConfigure(PoseStack p_86662_, int p_86663_, int p_86664_, int p_86665_, int p_86666_)
    {
        ...
        if (flag)
        {
            this.m_86526_(CONFIGURE_SERVER_TOOLTIP);
    ...
    void renderMoreInfo(PoseStack p_86418_, int p_86419_, int p_86420_, int p_86421_, int p_86422_, boolean p_86423_)
    {
        ...
        if (flag)
        {
            this.m_86526_(SERVER_INFO_TOOLTIP);
        }
    }
    ...
    {
        Collection<ResourceLocation> collection = p_86407_.listResources("textures/gui/images", (p_86567_) ->
        {
            return p_86567_.endsWith(".png");
        });
        teaserImages = collection.stream().filter((p_86523_) ->
        {
            return p_86523_.getNamespace().equals("realms");
    ...
    {
        this.toolTip = ImmutableList.copyOf(p_167189_);
    }
    ...
    class CloseButton extends Button
    {
        ...
        public void renderButton(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
        {
            ...
            blit(pMatrixStack, this.x, this.y, 0.0F, f, 12, 12, 12, 24);

            if (this.isMouseOver((double)pMouseX, (double)pMouseY))
            {
                RealmsMainScreen.this.m_86526_(this.getMessage());
            }
        }
    }
    ...
    class NewsButton extends Button
    {
        ...
        public void renderButton(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
        {
            RealmsMainScreen.this.renderNews(pMatrixStack, pMouseX, pMouseY, RealmsMainScreen.this.hasUnreadNews, this.x, this.y, this.isHovered(), this.active);
        }
    }
    ...
    class PendingInvitesButton extends Button
    {
        ...
        public void renderButton(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
        {
            RealmsMainScreen.this.drawInvitationPendingIcon(pMatrixStack, pMouseX, pMouseY, this.x, this.y, this.isHovered(), this.active);
        }
    }
    ...
    class RealmSelectionList extends RealmsObjectSelectionList<RealmsMainScreen.Entry>
    {
        ...
        public int addMessageEntry(RealmsMainScreen.Entry p_86844_)
        {
            this.showingMessage = true;
            return this.addEntry(p_86844_);
        }
        ...
        public boolean keyPressed(int pKeyCode, int pScanCode, int pModifiers)
        {
            ...
            else
            {
                ...
                return realmsmainscreen$entry == null ? super.keyPressed(pKeyCode, pScanCode, pModifiers) : realmsmainscreen$entry.mouseClicked(0.0D, 0.0D, 0);
            }
        }

        public boolean mouseClicked(double pMouseX, double p_86829_, int pMouseY)
        {
            if (pMouseY == 0 && pMouseX < (double)this.getScrollbarPosition() && p_86829_ >= (double)this.y0 && p_86829_ <= (double)this.y1)
            {
                ...
                {
                    this.itemClicked(k, l, pMouseX, p_86829_, this.width);
            ...
            {
                return super.mouseClicked(pMouseX, p_86829_, pMouseY);
            }
        }

        public void selectItem(int p_86832_)
        {
            this.setSelectedItem(p_86832_);
            ...
            if (p_86832_ != -1)
            {
                ...
                if (this.showingMessage)
                {
                    ...
                    {
                        if (p_86832_ - 1 >= RealmsMainScreen.this.realmsServers.size())
                        {
                            RealmsMainScreen.this.selectedServerId = -1L;
                            return;
                        }

                        realmsserver = RealmsMainScreen.this.realmsServers.get(p_86832_ - 1);
                    }
                }
                else
                {
                    if (p_86832_ >= RealmsMainScreen.this.realmsServers.size())
                    {
                        RealmsMainScreen.this.selectedServerId = -1L;
                        return;
                    }

                    realmsserver = RealmsMainScreen.this.realmsServers.get(p_86832_);
                }
        ...
        public void setSelected(@Nullable RealmsMainScreen.Entry pEntry)
        {
            super.setSelected(pEntry);
            int i = this.children().indexOf(pEntry) - (this.showingMessage ? 1 : 0);
        ...
        public void itemClicked(int p_86834_, int p_86835_, double p_86836_, double p_86837_, int p_86838_)
        {
            ...
            if (p_86835_ < RealmsMainScreen.this.realmsServers.size())
            {
                RealmsServer realmsserver = RealmsMainScreen.this.realmsServers.get(p_86835_);
    ...
    class ServerEntry extends RealmsMainScreen.Entry
    {
        ...
        {
            this.renderMcoServerItem(this.serverData, pMatrixStack, pLeft, pTop, pMouseX, pMouseY);
        }

        public boolean mouseClicked(double pMouseX, double p_86859_, int pMouseY)
        {
        ...
        private void renderLegacy(RealmsServer p_86886_, PoseStack p_86887_, int p_86888_, int p_86889_, int p_86890_, int p_86891_)
        {
            ...
            else
            {
                ...
                if (!"0".equals(p_86886_.serverPing.nrOfPlayers))
                {
                    ...
                    {
                        RealmsMainScreen.this.m_86526_(new TextComponent(p_86886_.serverPing.playerList));
                    }
                }
    ...
    class ShowPopupButton extends Button
    {
        ...
        public void renderButton(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
        {
            RealmsMainScreen.this.renderMoreInfo(pMatrixStack, pMouseX, pMouseY, this.x, this.y, this.isHovered());
        }
    }
    ...
    class TrialEntry extends RealmsMainScreen.Entry
    {
        public void render(PoseStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks)
        {
            this.renderTrialItem(pMatrixStack, pIndex, pLeft, pTop, pMouseX, pMouseY);
        }

        public boolean mouseClicked(double pMouseX, double p_86911_, int pMouseY)
        {
            RealmsMainScreen.this.popupOpenedByUser = true;
            return true;
        }

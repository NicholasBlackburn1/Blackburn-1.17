...
public class RealmsWorldSlotButton extends Button
{
    ...
    public void renderButton(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        if (this.state != null)
        {
            this.drawSlotFrame(pMatrixStack, this.x, this.y, pMouseX, pMouseY, this.state.isCurrentlyActiveSlot, this.state.slotName, this.slotIndex, this.state.imageId, this.state.image, this.state.empty, this.state.minigame, this.state.action, this.state.actionPrompt);
        }
    }

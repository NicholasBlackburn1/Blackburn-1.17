...
public class RealmsResetWorldScreen extends RealmsScreen
{
    ...
    class FrameButton extends Button
    {
        ...
        {
            RealmsResetWorldScreen.this.drawFrame(pMatrixStack, this.x, this.y, this.getMessage(), this.image, this.isHovered(), this.isMouseOver((double)pMouseX, (double)pMouseY));
        }
    }
}

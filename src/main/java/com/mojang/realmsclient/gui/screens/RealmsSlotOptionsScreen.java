...
public class RealmsSlotOptionsScreen extends RealmsScreen
{
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        this.font.draw(pMatrixStack, NAME_LABEL, (float)(this.column1X + this.columnWidth / 2 - this.font.width(NAME_LABEL) / 2), (float)(row(0) - 5), 16777215);
    ...
    class SettingsSlider extends AbstractSliderButton
    {
        ...
        public void onClick(double pMouseX, double p_89955_)
        {
        }

        public void onRelease(double pMouseX, double p_89958_)
        {
        }
    }
}

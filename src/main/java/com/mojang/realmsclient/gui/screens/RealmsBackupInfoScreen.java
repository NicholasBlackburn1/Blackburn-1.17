...
public class RealmsBackupInfoScreen extends RealmsScreen
{
    ...
    class BackupInfoListEntry extends ObjectSelectionList.Entry<RealmsBackupInfoScreen.BackupInfoListEntry>
    {
        ...
        public void render(PoseStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks)
        {
            ...
            GuiComponent.drawString(pMatrixStack, font, this.key, pLeft, pTop, 10526880);
            GuiComponent.drawString(pMatrixStack, font, RealmsBackupInfoScreen.this.checkForSpecificMetadata(this.key, this.value), pLeft, pTop + 12, 16777215);
        }

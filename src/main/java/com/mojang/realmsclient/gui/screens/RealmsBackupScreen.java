...
public class RealmsBackupScreen extends RealmsScreen
{
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        this.backupObjectSelectionList.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        drawCenteredString(pMatrixStack, this.font, this.title, this.width / 2, 12, 16777215);
        this.font.draw(pMatrixStack, TITLE, (float)((this.width - 150) / 2 - 90), 20.0F, 10526880);

        if (this.noBackups)
        {
            this.font.draw(pMatrixStack, NO_BACKUPS_LABEL, 20.0F, (float)(this.height / 2 - 10), 16777215);
        }
    ...
    class BackupObjectSelectionList extends RealmsObjectSelectionList<RealmsBackupScreen.Entry>
    {
        ...
        {
            RealmsBackupScreen.this.renderBackground(pMatrixStack);
        }
        ...
        public void setSelected(@Nullable RealmsBackupScreen.Entry pEntry)
        {
            super.setSelected(pEntry);
            RealmsBackupScreen.this.selectedBackup = this.children().indexOf(pEntry);
            RealmsBackupScreen.this.updateButtonStates();
        }
    }
    ...
    class Entry extends ObjectSelectionList.Entry<RealmsBackupScreen.Entry>
    {
        ...
        {
            this.renderBackupItem(pMatrixStack, this.backup, pLeft - 40, pTop, pMouseX, pMouseY);
        }

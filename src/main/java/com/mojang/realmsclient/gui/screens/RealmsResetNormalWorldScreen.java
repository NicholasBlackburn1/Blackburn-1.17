...
public class RealmsResetNormalWorldScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        this.addRenderableWidget(CycleButton.builder(LevelType::getName).m_168961_(LevelType.values()).withInitialValue(this.levelType).create(this.width / 2 - 102, row(4), 205, 20, new TranslatableComponent("selectWorld.mapType"), (p_167441_, p_167442_) ->
        {
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        this.font.draw(pMatrixStack, SEED_LABEL, (float)(this.width / 2 - 100), (float)row(1), 10526880);

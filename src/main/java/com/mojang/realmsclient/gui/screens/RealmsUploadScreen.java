...
public class RealmsUploadScreen extends RealmsScreen
{
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        if (this.uploadStatus.bytesWritten != 0L && !this.cancelled)
        {
            ...
            this.drawUploadSpeed(pMatrixStack);
        }
        ...
        if (this.errorMessage != null)
        {
            ...
            {
                drawCenteredString(pMatrixStack, this.font, this.errorMessage[i], this.width / 2, 110 + 12 * i, 16711680);
            }
        }
                ...
                if (UPLOAD_LOCK.tryLock(1L, TimeUnit.SECONDS))
                {
                    ...
                    if (this.verify(file1))
                    {
                        ...
                        fileupload.upload((p_167557_) ->
                        {
                            ...
                            {
                                this.m_90112_(new TranslatableComponent("mco.upload.failed", p_167557_.errorMessage));
                            }
                            else {
                                this.m_90112_(new TranslatableComponent("mco.upload.failed", p_167557_.statusCode));
                            }
                        });
                    ...
                    if (Unit.humanReadable(k, unit).equals(Unit.humanReadable(5368709120L, unit1)) && unit != Unit.B)
                    {
                        ...
                        this.m_90112_(new TranslatableComponent("mco.upload.size.failure.line1", this.selectedLevel.getLevelName()), new TranslatableComponent("mco.upload.size.failure.line2", Unit.humanReadable(k, unit2), Unit.humanReadable(5368709120L, unit2)));
                        return;
                    }

                    this.m_90112_(new TranslatableComponent("mco.upload.size.failure.line1", this.selectedLevel.getLevelName()), new TranslatableComponent("mco.upload.size.failure.line2", Unit.humanReadable(k, unit), Unit.humanReadable(5368709120L, unit1)));
                    return;
                }

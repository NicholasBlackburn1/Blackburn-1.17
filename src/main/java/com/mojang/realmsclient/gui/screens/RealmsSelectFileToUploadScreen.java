...
public class RealmsSelectFileToUploadScreen extends RealmsScreen
{
    ...
    class Entry extends ObjectSelectionList.Entry<RealmsSelectFileToUploadScreen.Entry>
    {
        ...
        public boolean mouseClicked(double pMouseX, double p_89563_, int pMouseY)
        {
        ...
        {
            Component component = CommonComponents.m_178396_(new TextComponent(this.levelSummary.getLevelName()), new TextComponent(RealmsSelectFileToUploadScreen.formatLastPlayed(this.levelSummary)), RealmsSelectFileToUploadScreen.gameModeName(this.levelSummary));

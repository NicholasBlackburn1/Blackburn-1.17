...
public class RealmsPendingInvitesScreen extends RealmsScreen
{
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        drawCenteredString(pMatrixStack, this.font, this.title, this.width / 2, 12, 16777215);
    ...
    class Entry extends ObjectSelectionList.Entry<RealmsPendingInvitesScreen.Entry>
    {
        ...
        public boolean mouseClicked(double pMouseX, double p_88999_, int pMouseY)
        {
            RowButton.rowButtonMouseClicked(RealmsPendingInvitesScreen.this.pendingInvitationSelectionList, this, this.rowButtons, pMouseY, pMouseX, p_88999_);
            return true;
        }
        ...
        {
            Component component = CommonComponents.m_178396_(new TextComponent(this.pendingInvite.worldName), new TextComponent(this.pendingInvite.worldOwnerName), new TextComponent(RealmsUtil.convertToAgePresentationFromInstant(this.pendingInvite.date)));
    ...
    class PendingInvitationSelectionList extends RealmsObjectSelectionList<RealmsPendingInvitesScreen.Entry>
    {
        ...
        public void setSelected(@Nullable RealmsPendingInvitesScreen.Entry pEntry)
        {

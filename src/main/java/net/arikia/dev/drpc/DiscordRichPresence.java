...
public class DiscordRichPresence extends Structure {
	...
	public static class Builder {
		 ...
		 */
		public Builder(String state,String details, String largeImageKey,int partySize,int partymax) {
			p = new DiscordRichPresence();
			p.state = state;
			p.details = details;
			p.largeImageKey = largeImageKey;
			p.partySize = partySize;
			p.partyMax = partymax;
		}
		...
		public Builder(String state, String largeImageKey,int partySize,int partymax) {
			p = new DiscordRichPresence();
			p.state = state;
			p.largeImageKey = largeImageKey;
			p.partySize = partySize;

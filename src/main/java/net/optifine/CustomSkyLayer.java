...
public class CustomSkyLayer
{
    ...
    {
        float f = matrix4f.getTransformX(x, y, z, 1.0F);
        float f1 = matrix4f.getTransformY(x, y, z, 1.0F);
        float f2 = matrix4f.getTransformZ(x, y, z, 1.0F);
        buffer.vertex((double)f, (double)f1, (double)f2).uv(u, v).endVertex();
    }

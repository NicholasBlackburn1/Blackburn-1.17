...
public class GuiShaders extends GuiScreenOF
{
    ...
    {
        super(new TextComponent(I18n.m_118938_("of.options.shadersTitle")));
    ...
    public void init()
    {
        ...
        this.addRenderableWidget(new GuiButtonOF(202, j1 / 4 * 3 - k1 / 2, this.height - 25, k1, j, I18n.m_118938_("gui.done")));
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        this.shaderList.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        ...
        if (i < this.width - 5)
        {
            drawCenteredString(pMatrixStack, this.fontRenderer, s, this.width / 2, this.height - 40, 8421504);
        }
        else
        {
            drawString(pMatrixStack, this.fontRenderer, s, 5, this.height - 40, 8421504);
        }

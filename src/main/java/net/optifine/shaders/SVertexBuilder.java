...
public class SVertexBuilder
{
    ...
    public static void endSetVertexFormat(BufferBuilder wrr)
    {
        ...
        svertexbuilder.vertexSize = vertexformat.getVertexSize() / 4;
    ...
    public static void endAddVertexData(BufferBuilder wrr)
    {
        ...
        if (svertexbuilder.vertexSize == 18 && wrr.getDrawMode() == VertexFormat.Mode.QUADS && wrr.getVertexCount() % 4 == 0)
        {
            svertexbuilder.calcNormal(wrr, wrr.getBufferIntSize() - 4 * svertexbuilder.vertexSize);
        }
    }
    ...
    public void calcNormal(BufferBuilder wrr, int baseIndex)
    {
        ...
        if (wrr.getVertexFormat() == DefaultVertexFormat.BLOCK)
        {
            Vector3f vector3f = wrr.getMidBlock();
            float f51 = vector3f.x();
            float f49 = vector3f.y();
            float f50 = vector3f.z();
    ...
    public static boolean preDrawArrays(VertexFormat vf)
    {
        ...
        {
            GL20.glVertexAttribPointer(Shaders.midTexCoordAttrib, 2, GL11.GL_FLOAT, false, i, 36L);
            GL20.glVertexAttribPointer(Shaders.tangentAttrib, 4, GL11.GL_SHORT, false, i, 44L);
            GL20.glVertexAttribPointer(Shaders.entityAttrib, 3, GL11.GL_SHORT, false, i, 52L);
            GL20.glVertexAttribPointer(Shaders.velocityAttrib, 3, GL11.GL_FLOAT, false, i, 60L);

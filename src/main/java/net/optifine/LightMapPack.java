...
public class LightMapPack
{
    ...
    public boolean updateLightmap(ClientLevel world, float torchFlickerX, NativeImage lmColorsImage, boolean nightvision, float partialTicks)
    {
    ...
    public boolean updateLightmap(ClientLevel world, float torchFlickerX, int[] lmColors, boolean nightvision, float partialTicks)
    {
        ...
        else if (!WorldUtils.isEnd(world) && !WorldUtils.isNether(world))
        {
            ...
            float f1 = world.getThunderLevel(partialTicks);
            float f2 = 1.0E-4F;
            boolean flag = f > f2;
            boolean flag1 = f1 > f2;

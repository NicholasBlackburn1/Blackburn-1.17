...
public class VersionCheckThread extends Thread
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            URL url = new URL("http://optifine.net/version/1.17.1/HD_U.txt");
            httpurlconnection = (HttpURLConnection)url.openConnection();

            if (Config.getGameSettings().snooperEnabled)
            {
                httpurlconnection.setRequestProperty("OF-MC-Version", "1.17.1");
                ...
                httpurlconnection.setRequestProperty("OF-Release", "G9_pre34");
            ...
            try
            {
                ...
                if (astring.length >= 1)
                {
                    ...
                    if (Config.compareRelease(s1, "G9_pre34") <= 0)
                    {
                        return;
                    }

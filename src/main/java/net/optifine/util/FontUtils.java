...
public class FontUtils
{
    ...
    public static void reloadFonts()
    {
        ...
        if (fontmanager != null)
        {
            fontmanager.getReloadListener().reload(preparablereloadlistener$preparationbarrier, Config.getResourceManager(), InactiveProfiler.INSTANCE, InactiveProfiler.INSTANCE, executor, minecraft);
        }
    }
}

...
public class CustomLoadingScreen
{
    ...
    public void drawBackground(int width, int height)
    {
        ...
        Config.getTextureManager().bindForSetup(this.locationTexture);
        ...
        bufferbuilder.vertex(0.0D, (double)height, 0.0D).uv(f3, f4 + f2).color(255, 255, 255, 255).endVertex();
        bufferbuilder.vertex((double)width, (double)height, 0.0D).uv(f3 + f1, f4 + f2).color(255, 255, 255, 255).endVertex();
        bufferbuilder.vertex((double)width, 0.0D, 0.0D).uv(f3 + f1, f4).color(255, 255, 255, 255).endVertex();
        bufferbuilder.vertex(0.0D, 0.0D, 0.0D).uv(f3, f4).color(255, 255, 255, 255).endVertex();
        tesselator.end();
    }
}

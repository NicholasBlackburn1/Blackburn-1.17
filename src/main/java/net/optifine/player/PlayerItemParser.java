...
public class PlayerItemParser
{
    ...
    public static PlayerItemRenderer parseItemRenderer(JsonObject elem, Dimension textureDim)
    {
        ...
        else
        {
            ...
            ModelPart modelpart = parseModelRenderer(elem, model, (int[])null, (String)null);
    ...
    public static ModelPart parseModelRenderer(JsonObject elem, Model modelBase, int[] parentTextureSize, String basePath)
    {
        ...
        if (jsonarray != null)
        {
            for (int j = 0; j < jsonarray.size(); ++j)
            {
                ...
                if (aint2 != null)
                {
                    modelpart.addBox(aint2, afloat2[0], afloat2[1], afloat2[2], afloat2[3], afloat2[4], afloat2[5], f1);
                }
                else
                {
                    modelpart.setTextureOffset(aint1[0], aint1[1]);
                    modelpart.addBox(afloat2[0], afloat2[1], afloat2[2], (float)((int)afloat2[3]), (float)((int)afloat2[4]), (float)((int)afloat2[5]), f1);
                }
            }
        }
        ...
        if (jsonarray1 != null)
        {
            for (int k = 0; k < jsonarray1.size(); ++k)
            {
                ...
                modelpart.setTextureOffset(aint3[0], aint3[1]);
                modelpart.addSprite(afloat3[0], afloat3[1], afloat3[2], (int)afloat3[3], (int)afloat3[4], (int)afloat3[5], f2);
            }
        }
        ...
        if (jsonarray2 != null)
        {
            for (int l = 0; l < jsonarray2.size(); ++l)
            {
                ...
                {
                    ModelPart modelpart1 = modelpart.getChild(modelpart3.getId());

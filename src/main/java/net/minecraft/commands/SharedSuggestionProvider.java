...
default Collection<String> getSelectedEntities()
    ...
    CompletableFuture<Suggestions> customSuggestion(CommandContext<SharedSuggestionProvider> pContext, SuggestionsBuilder pSuggestionsBuilder);
...
default Collection<SharedSuggestionProvider.TextCoordinates> getAbsoluteCoordinates()
    ...
    static CompletableFuture<Suggestions> suggestResource(Iterable<ResourceLocation> p_82930_, SuggestionsBuilder pBuilder, String p_82932_)
    {
        ...
        {
            pBuilder.suggest(p_82932_ + p_82917_);
        });
        return pBuilder.buildFuture();
    }

    static CompletableFuture<Suggestions> suggestResource(Iterable<ResourceLocation> p_82927_, SuggestionsBuilder pBuilder)
    {
        String s = pBuilder.getRemaining().toLowerCase(Locale.ROOT);
    ...
    static <T> CompletableFuture<Suggestions> suggestResource(Iterable<T> p_82934_, SuggestionsBuilder pBuilder, Function<T, ResourceLocation> p_82936_, Function<T, Message> p_82937_)
    {
        String s = pBuilder.getRemaining().toLowerCase(Locale.ROOT);
        filterResources(p_82934_, s, p_82936_, (p_82922_) ->
        {
            pBuilder.suggest(p_82936_.apply(p_82922_).toString(), p_82937_.apply(p_82922_));
        });
        return pBuilder.buildFuture();
    }

    static CompletableFuture<Suggestions> suggestResource(Stream<ResourceLocation> p_82958_, SuggestionsBuilder pBuilder)
    {
        return suggestResource(p_82958_::iterator, pBuilder);
    }

    static <T> CompletableFuture<Suggestions> suggestResource(Stream<T> p_82961_, SuggestionsBuilder pBuilder, Function<T, ResourceLocation> p_82963_, Function<T, Message> p_82964_)
    {
        return suggestResource(p_82961_::iterator, pBuilder, p_82963_, p_82964_);
    }
    ...
    static CompletableFuture<Suggestions> suggest(Iterable<String> p_82971_, SuggestionsBuilder pBuilder)
    {
        String s = pBuilder.getRemaining().toLowerCase(Locale.ROOT);
    ...
    static CompletableFuture<Suggestions> suggest(Stream<String> p_82982_, SuggestionsBuilder pBuilder)
    {
        String s = pBuilder.getRemaining().toLowerCase(Locale.ROOT);
    ...
    static <T> CompletableFuture<Suggestions> suggest(Iterable<T> p_165917_, SuggestionsBuilder pBuilder, Function<T, String> p_165919_, Function<T, Message> p_165920_)
    {
        String s = pBuilder.getRemaining().toLowerCase(Locale.ROOT);
        ...
        for (T t : p_165917_)
        {
            ...
            if (matchesSubStr(s, s1.toLowerCase(Locale.ROOT)))
            {
                pBuilder.suggest(s1, p_165920_.apply(t));
            }
        }

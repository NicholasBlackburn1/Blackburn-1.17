...
public class WorldCoordinates implements Coordinates
{
    ...
    public static WorldCoordinates parseDouble(StringReader pReader, boolean pCenterIntegers) throws CommandSyntaxException
    {
        int i = pReader.getCursor();
        WorldCoordinate worldcoordinate = WorldCoordinate.parseDouble(pReader, pCenterIntegers);
        ...
        if (pReader.canRead() && pReader.peek() == ' ')
        {
            ...
            {
                pReader.skip();
                WorldCoordinate worldcoordinate2 = WorldCoordinate.parseDouble(pReader, pCenterIntegers);
                return new WorldCoordinates(worldcoordinate, worldcoordinate1, worldcoordinate2);
            }
            else
            {

...
public class ScoreHolderArgument implements ArgumentType<ScoreHolderArgument.Result>
{
    ...
    public static Collection<String> getNames(CommandContext<CommandSourceStack> pContext, String pName, Supplier<Collection<String>> p_108229_) throws CommandSyntaxException
    {
        Collection<String> collection = pContext.getArgument(pName, ScoreHolderArgument.Result.class).getNames(pContext.getSource(), p_108229_);

...
public class ParticleArgument implements ArgumentType<ParticleOptions>
{
    ...
    private static <T extends ParticleOptions> T readParticle(StringReader pReader, ParticleType<T> p_103936_) throws CommandSyntaxException
    {
        return p_103936_.getDeserializer().fromCommand(p_103936_, pReader);
    }

...
public class ScoreboardSlotArgument implements ArgumentType<Integer>
{
    ...
    public static int getDisplaySlot(CommandContext<CommandSourceStack> pContext, String pName)
    {
    ...
    {
        return SharedSuggestionProvider.m_82967_(Scoreboard.getDisplaySlotNames(), p_109207_);
    }

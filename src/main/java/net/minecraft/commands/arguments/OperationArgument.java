...
public class OperationArgument implements ArgumentType<OperationArgument.Operation>
{
    ...
    private static OperationArgument.Operation getOperation(String pContext) throws CommandSyntaxException
    {
        return (pContext.equals("><") ? (p_103279_, p_103280_) ->
        {
            int i = p_103279_.getScore();
            p_103279_.setScore(p_103280_.getScore());
            p_103280_.setScore(i);
        } : getSimpleOperation(pContext));
    }

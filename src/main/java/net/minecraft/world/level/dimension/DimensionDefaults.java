...
public class DimensionDefaults {
   ...
   public static final int OVERWORLD_LEVEL_HEIGHT = 256;
   public static final int OVERWORLD_GENERATION_HEIGHT = 256;
   public static final int OVERWORLD_LOGICAL_HEIGHT = 256;

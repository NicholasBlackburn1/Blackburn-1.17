...
public class EntityStorage implements EntityPersistentStorage<Entity> {
   ...
   public EntityStorage(ServerLevel p_156544_, File p_156545_, DataFixer p_156546_, boolean p_156547_, Executor p_156548_) {
      this.level = p_156544_;
      this.fixerUpper = p_156546_;
      this.entityDeserializerQueue = ProcessorMailbox.create(p_156548_, "entity-deserializer");
      this.worker = new IOWorker(p_156545_, p_156547_, "entities");
   }

...
public class SkyLightSectionStorage extends LayerLightSectionStorage<SkyLightSectionStorage.SkyDataLayerStorageMap>
{
    ...
    protected int getLightValue(long pLevelPos, boolean p_164459_)
    {
        ...
        if (k != skylightsectionstorage$skydatalayerstoragemap.currentLowestY && j < k)
        {
            ...
            if (datalayer == null)
            {
                for (pLevelPos = BlockPos.getFlatIndex(pLevelPos); datalayer == null; datalayer = this.getDataLayer(skylightsectionstorage$skydatalayerstoragemap, i))
                {
                    ++j;

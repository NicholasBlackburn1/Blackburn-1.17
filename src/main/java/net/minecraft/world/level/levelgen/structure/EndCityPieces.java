...
public class EndCityPieces
{
    ...
    static final EndCityPieces.SectionGenerator TOWER_GENERATOR = new EndCityPieces.SectionGenerator()
    {
        ...
        public boolean generate(StructureManager p_71170_, int p_71171_, EndCityPieces.EndCityPiece p_71172_, BlockPos p_71173_, List<StructurePiece> p_71174_, Random p_71175_)
        {
            ...
            EndCityPieces.EndCityPiece endcitypieces$endcitypiece = EndCityPieces.addHelper(p_71174_, EndCityPieces.addPiece(p_71170_, p_71172_, new BlockPos(3 + p_71175_.nextInt(2), -3, 3 + p_71175_.nextInt(2)), "tower_base", rotation, true));
            endcitypieces$endcitypiece = EndCityPieces.addHelper(p_71174_, EndCityPieces.addPiece(p_71170_, endcitypieces$endcitypiece, new BlockPos(0, 7, 0), "tower_piece", rotation, true));
            ...
            for (int j = 0; j < i; ++j)
            {
                endcitypieces$endcitypiece = EndCityPieces.addHelper(p_71174_, EndCityPieces.addPiece(p_71170_, endcitypieces$endcitypiece, new BlockPos(0, 4, 0), "tower_piece", rotation, true));
            ...
            if (endcitypieces$endcitypiece1 != null)
            {
                ...
                EndCityPieces.addHelper(p_71174_, EndCityPieces.addPiece(p_71170_, endcitypieces$endcitypiece, new BlockPos(-1, 4, -1), "tower_top", rotation, true));
            }
            else
            {
                if (p_71171_ != 7)
                {
                    return EndCityPieces.recursiveChildren(p_71170_, EndCityPieces.FAT_TOWER_GENERATOR, p_71171_ + 1, endcitypieces$endcitypiece, (BlockPos)null, p_71174_, p_71175_);
                }
    ...
    static EndCityPieces.EndCityPiece addPiece(StructureManager p_71135_, EndCityPieces.EndCityPiece p_71136_, BlockPos p_71137_, String p_71138_, Rotation p_71139_, boolean pOverwrite)
    {
        EndCityPieces.EndCityPiece endcitypieces$endcitypiece = new EndCityPieces.EndCityPiece(p_71135_, p_71138_, p_71136_.templatePosition, p_71139_, pOverwrite);
        ...
        else
        {
            ...
            if (p_71143_.generate(p_71142_, p_71144_, p_71145_, p_71146_, list, p_71148_))
            {
                ...
                for (StructurePiece structurepiece : list)
                {
                    ...
                    StructurePiece structurepiece1 = StructureStart.findCollisionPiece(p_71147_, structurepiece.getBoundingBox());
    ...
    public static class EndCityPiece extends TemplateStructurePiece
    {
        ...
        {
            super(StructurePieceType.END_CITY_PIECE, p_162419_, p_162418_, (p_162428_) ->
            {
                return makeSettings(p_162419_.getBoolean("OW"), Rotation.valueOf(p_162419_.getString("Rot")));
            });
        }
        ...
        protected void addAdditionalSaveData(ServerLevel p_162422_, CompoundTag p_162423_)
        {
            super.addAdditionalSaveData(p_162422_, p_162423_);
            p_162423_.putString("Rot", this.placeSettings.getRotation().name());
            p_162423_.putBoolean("OW", this.placeSettings.getProcessors().get(0) == BlockIgnoreProcessor.STRUCTURE_BLOCK);
        }
        ...
        protected void handleDataMarker(String pFunction, BlockPos pPos, ServerLevelAccessor pLevel, Random pRand, BoundingBox pSbb)
        {
            if (pFunction.startsWith("Chest"))
            {
                ...
                {
                    RandomizableContainerBlockEntity.setLootTable(pLevel, pRand, blockpos, BuiltInLootTables.END_CITY_TREASURE);
                }
            }
            else if (pSbb.isInside(pPos) && Level.isInSpawnableBounds(pPos))
            {
                if (pFunction.startsWith("Sentry"))
                {

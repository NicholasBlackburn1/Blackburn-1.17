...
{
    private static final WeightedRandomList<MobSpawnSettings.SpawnerData> SWAMPHUT_ENEMIES = WeightedRandomList.m_146330_(new MobSpawnSettings.SpawnerData(EntityType.WITCH, 1, 1, 1));
    private static final WeightedRandomList<MobSpawnSettings.SpawnerData> SWAMPHUT_ANIMALS = WeightedRandomList.m_146330_(new MobSpawnSettings.SpawnerData(EntityType.CAT, 1, 1, 1));

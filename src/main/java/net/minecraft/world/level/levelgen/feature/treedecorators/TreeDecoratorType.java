...
public class TreeDecoratorType<P extends TreeDecorator>
{
    ...
    private static <P extends TreeDecorator> TreeDecoratorType<P> register(String p_70053_, Codec<P> pCodec)
    {
        return Registry.register(Registry.TREE_DECORATOR_TYPES, p_70053_, new TreeDecoratorType<>(pCodec));
    }

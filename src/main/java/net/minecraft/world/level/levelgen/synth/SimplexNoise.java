...
public class SimplexNoise
{
    ...
    private int p(int pPermutIndex)
    {
        return this.p[pPermutIndex & 255];
    }
    ...
    private double getCornerNoise3D(int pGradIndex, double pX, double p_75476_, double pY, double p_75478_)
    {
        double d1 = p_75478_ - pX * pX - p_75476_ * p_75476_ - pY * pY;
        double d0;
        ...
        {
            d1 = d1 * d1;
            d0 = d1 * d1 * m_75479_(GRADIENT[pGradIndex], pX, p_75476_, pY);
        }

        return d0;
    }

    public double getValue(double pX, double p_75466_)
    {
        double d0 = (pX + p_75466_) * F2;
    ...
    public double getValue(double pX, double p_75469_, double pY)
    {
        double d0 = 0.3333333333333333D;
        double d1 = (pX + p_75469_ + pY) * 0.3333333333333333D;
        int i = Mth.floor(pX + d1);
        int j = Mth.floor(p_75469_ + d1);
        int k = Mth.floor(pY + d1);

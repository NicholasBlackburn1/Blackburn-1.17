...
public class Cavifier implements NoiseModifier
{
    ...
    public Cavifier(RandomSource p_158115_, int p_158116_)
    {
        ...
        this.pillarNoiseSource = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -7, 1.0D, 1.0D);
        this.pillarRarenessModulator = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -8, 1.0D);
        this.pillarThicknessModulator = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -8, 1.0D);
        this.spaghetti2dNoiseSource = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -7, 1.0D);
        this.spaghetti2dElevationModulator = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -8, 1.0D);
        this.spaghetti2dRarityModulator = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -11, 1.0D);
        this.spaghetti2dThicknessModulator = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -11, 1.0D);
        this.spaghetti3dNoiseSource1 = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -7, 1.0D);
        this.spaghetti3dNoiseSource2 = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -7, 1.0D);
        this.spaghetti3dRarityModulator = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -11, 1.0D);
        this.spaghetti3dThicknessModulator = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -8, 1.0D);
        this.spaghettiRoughnessNoise = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -5, 1.0D);
        this.spaghettiRoughnessModulator = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -8, 1.0D);
        this.caveEntranceNoiseSource = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -8, 1.0D, 1.0D, 1.0D);
        this.layerNoiseSource = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -8, 1.0D);
        this.cheeseNoiseSource = NormalNoise.m_164354_(new SimpleRandomSource(p_158115_.nextLong()), -8, 0.5D, 1.0D, 2.0D, 1.0D, 2.0D, 1.0D, 0.0D, 2.0D, 0.0D);
    }

...
public class AxisAlignedLinearPosTest extends PosRuleTest
{
    ...
    public boolean test(BlockPos p_73981_, BlockPos p_73982_, BlockPos p_73983_, Random pRand)
    {
        ...
        int i = (int)(f + f1 + f2);
        float f3 = pRand.nextFloat();
        return (double)f3 <= Mth.clampedLerp((double)this.minChance, (double)this.maxChance, Mth.inverseLerp((double)i, (double)this.minDist, (double)this.maxDist));
    }

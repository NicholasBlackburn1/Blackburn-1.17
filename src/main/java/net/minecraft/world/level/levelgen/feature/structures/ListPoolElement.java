...
public class ListPoolElement extends StructurePoolElement
{
    ...
    {
        return this.elements.get(0).getShuffledJigsawBlocks(pTemplateManager, pPos, pRotation, pRand);
    }
    ...
    public BoundingBox getBoundingBox(StructureManager pTemplateManager, BlockPos pPos, Rotation pRotation)
    {
        ...
        {
            return p_161661_.getBoundingBox(pTemplateManager, pPos, pRotation);
        });
    ...
    {
        super.setProjection(pDecoratorBehaviour);
        this.setProjectionOnEachElement(pDecoratorBehaviour);
        return this;
    }

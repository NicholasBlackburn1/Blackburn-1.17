...
public class OreVeinifier
{
    ...
    public OreVeinifier(long p_158806_, BlockState p_158807_, int p_158808_, int p_158809_, int p_158810_)
    {
        ...
        this.veininessNoiseSource = NormalNoise.m_164354_(new SimpleRandomSource(random.nextLong()), -8, 1.0D);
        this.veinANoiseSource = NormalNoise.m_164354_(new SimpleRandomSource(random.nextLong()), -7, 1.0D);
        this.veinBNoiseSource = NormalNoise.m_164354_(new SimpleRandomSource(random.nextLong()), -7, 1.0D);
        this.gapNoise = NormalNoise.m_164354_(new SimpleRandomSource(0L), -5, 1.0D);
    ...
    {
        this.m_158833_(p_158828_, p_158829_, p_158830_, this.veininessNoiseSource, 1.5D, p_158831_, p_158832_);
    }

    public void m_158843_(double[] p_158844_, int p_158845_, int p_158846_, int p_158847_, int p_158848_)
    {
        this.m_158833_(p_158844_, p_158845_, p_158846_, this.veinANoiseSource, 4.0D, p_158847_, p_158848_);
    }

    public void m_158849_(double[] p_158850_, int p_158851_, int p_158852_, int p_158853_, int p_158854_)
    {
        this.m_158833_(p_158850_, p_158851_, p_158852_, this.veinBNoiseSource, 4.0D, p_158853_, p_158854_);
    }

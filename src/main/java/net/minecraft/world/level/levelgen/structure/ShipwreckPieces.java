...
public class ShipwreckPieces
{
    ...
    {
        ResourceLocation resourcelocation = Util.m_137545_(p_163206_.isBeached ? STRUCTURE_LOCATION_BEACHED : STRUCTURE_LOCATION_OCEAN, p_163205_);
    ...
    public static class ShipwreckPiece extends TemplateStructurePiece
    {
        ...
        protected void handleDataMarker(String pFunction, BlockPos pPos, ServerLevelAccessor pLevel, Random pRand, BoundingBox pSbb)
        {
            ...
            {
                RandomizableContainerBlockEntity.setLootTable(pLevel, pRand, pPos.below(), BuiltInLootTables.SHIPWRECK_MAP);
            }
            else if ("treasure_chest".equals(pFunction))
            {
                RandomizableContainerBlockEntity.setLootTable(pLevel, pRand, pPos.below(), BuiltInLootTables.SHIPWRECK_TREASURE);
            }
            else if ("supply_chest".equals(pFunction))
            {
                RandomizableContainerBlockEntity.setLootTable(pLevel, pRand, pPos.below(), BuiltInLootTables.SHIPWRECK_SUPPLY);
            }
        }

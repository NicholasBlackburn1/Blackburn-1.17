...
public class TreeConfiguration implements FeatureConfiguration
{
    ...
    public TreeConfiguration withDecorators(List<TreeDecorator> pDecorators)
    {
        return new TreeConfiguration(this.trunkProvider, this.trunkPlacer, this.foliageProvider, this.saplingProvider, this.foliagePlacer, this.dirtProvider, this.minimumSize, pDecorators, this.ignoreVines, this.forceDirt);
    }

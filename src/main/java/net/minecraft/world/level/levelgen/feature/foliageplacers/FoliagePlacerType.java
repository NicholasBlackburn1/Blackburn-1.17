...
public class FoliagePlacerType<P extends FoliagePlacer>
{
    ...
    private static <P extends FoliagePlacer> FoliagePlacerType<P> register(String pName, Codec<P> pCodec)
    {
        return Registry.register(Registry.FOLIAGE_PLACER_TYPES, pName, new FoliagePlacerType<>(pCodec));
    }

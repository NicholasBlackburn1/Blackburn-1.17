...
{
    private static final WeightedRandomList<MobSpawnSettings.SpawnerData> MONUMENT_ENEMIES = WeightedRandomList.m_146330_(new MobSpawnSettings.SpawnerData(EntityType.GUARDIAN, 1, 2, 4));

...
public class NoiseInterpolator
{
    ...
    {
        this.m_158609_(this.slice0, this.firstCellXInChunk);
    }

    public void advanceCellX(int p_158605_)
    {
        this.m_158609_(this.slice1, this.firstCellXInChunk + p_158605_ + 1);
    }
    ...
    private void m_158609_(double[][] p_158610_, int p_158611_)
    {
        for (int i = 0; i < this.cellCountZ + 1; ++i)
        {
            ...
            this.noiseColumnFiller.m_158620_(p_158610_[i], p_158611_, j, this.cellNoiseMinY, this.cellCountY);
        }
    }

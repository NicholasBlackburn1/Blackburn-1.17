...
public abstract class Feature<FC extends FeatureConfiguration>
{
    ...
    public static final AbstractFlowerFeature<RandomPatchConfiguration> NO_BONEMEAL_FLOWER = register("no_bonemeal_flower", new DefaultFlowerFeature(RandomPatchConfiguration.CODEC));
    ...
    public static final Feature<BlockPileConfiguration> NETHER_FOREST_VEGETATION = register("nether_forest_vegetation", new NetherForestVegetationFeature(BlockPileConfiguration.CODEC));
    ...
    public static final Feature<SmallDripstoneConfiguration> SMALL_DRIPSTONE = register("small_dripstone", new SmallDripstoneFeature(SmallDripstoneConfiguration.CODEC));
    ...
    public ConfiguredFeature < FC, ? > configured(FC pConfig)
    {
        return new ConfiguredFeature<>(this, pConfig);
    }

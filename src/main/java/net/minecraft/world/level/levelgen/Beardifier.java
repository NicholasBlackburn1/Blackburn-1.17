...
public class Beardifier {
   ...
   protected double beardifyOrBury(int p_158073_, int p_158074_, int p_158075_) {
      double d0 = 0.0D;
      ...
      while(this.junctionIterator.hasNext()) {
         ...
         int l = p_158073_ - jigsawjunction.getSourceX();
         int i1 = p_158074_ - jigsawjunction.getSourceGroundY();
         int j1 = p_158075_ - jigsawjunction.getSourceZ();

...
public interface StructurePieceType
{
    ...
    StructurePiece load(ServerLevel p_160484_, CompoundTag p_160485_);

    static StructurePieceType setPieceId(StructurePieceType pType, String pKey)
    {
        return Registry.register(Registry.STRUCTURE_PIECE, pKey.toLowerCase(Locale.ROOT), pType);
    }
}

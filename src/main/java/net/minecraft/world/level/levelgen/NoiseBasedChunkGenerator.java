...
public final class NoiseBasedChunkGenerator extends ChunkGenerator
{
    ...
    private NoiseBasedChunkGenerator(BiomeSource p_64341_, BiomeSource p_64342_, long p_64343_, Supplier<NoiseGeneratorSettings> p_64344_)
    {
        ...
        this.barrierNoise = NormalNoise.m_164354_(new SimpleRandomSource(worldgenrandom.nextLong()), -3, 1.0D);
        this.waterLevelNoise = NormalNoise.m_164354_(new SimpleRandomSource(worldgenrandom.nextLong()), -3, 1.0D, 0.0D, 2.0D);
        this.lavaNoise = NormalNoise.m_164354_(new SimpleRandomSource(worldgenrandom.nextLong()), -1, 1.0D, 0.0D);
    ...
    private void m_158466_(double[] p_158467_, int p_158468_, int p_158469_, int p_158470_, int p_158471_)
    {
        ...
        this.sampler.m_158678_(p_158467_, p_158468_, p_158469_, noisesettings, this.getSeaLevel(), p_158470_, p_158471_);
    }
    ...
    public int getBaseHeight(int p_158405_, int p_158406_, Heightmap.Types p_158407_, LevelHeightAccessor p_158408_)
    {
        ...
        return l <= 0 ? p_158408_.getMinBuildHeight() : this.m_158413_(p_158405_, p_158406_, (BlockState[])null, p_158407_.isOpaque(), k, l).orElse(p_158408_.getMinBuildHeight());
    }
    ...
    private void setBedrock(ChunkAccess pChunk, Random pRand)
    {
        BlockPos.MutableBlockPos blockpos$mutableblockpos = new BlockPos.MutableBlockPos();
    ...
    private ChunkAccess doFill(StructureFeatureManager p_158428_, ChunkAccess p_158429_, int p_158430_, int p_158431_)
    {
        ...
        NoiseInterpolator noiseinterpolator = new NoiseInterpolator(this.cellCountX, p_158431_, this.cellCountZ, chunkpos, p_158430_, this::m_158466_);
    ...
    class NoodleCaveNoiseModifier implements NoiseModifier
    {
        ...
        {
            this.toggle = new NoiseInterpolator(NoiseBasedChunkGenerator.this.cellCountX, NoiseBasedChunkGenerator.this.cellCountY, NoiseBasedChunkGenerator.this.cellCountZ, p_158501_, p_158502_, NoiseBasedChunkGenerator.this.noodleCavifier::m_158742_);
            this.thickness = new NoiseInterpolator(NoiseBasedChunkGenerator.this.cellCountX, NoiseBasedChunkGenerator.this.cellCountY, NoiseBasedChunkGenerator.this.cellCountZ, p_158501_, p_158502_, NoiseBasedChunkGenerator.this.noodleCavifier::m_158765_);
            this.ridgeA = new NoiseInterpolator(NoiseBasedChunkGenerator.this.cellCountX, NoiseBasedChunkGenerator.this.cellCountY, NoiseBasedChunkGenerator.this.cellCountZ, p_158501_, p_158502_, NoiseBasedChunkGenerator.this.noodleCavifier::m_158771_);
            this.ridgeB = new NoiseInterpolator(NoiseBasedChunkGenerator.this.cellCountX, NoiseBasedChunkGenerator.this.cellCountY, NoiseBasedChunkGenerator.this.cellCountZ, p_158501_, p_158502_, NoiseBasedChunkGenerator.this.noodleCavifier::m_158777_);
        }
    ...
    class OreVeinNoiseSource implements BaseStoneSource
    {
        ...
        {
            this.veininess = new NoiseInterpolator(NoiseBasedChunkGenerator.this.cellCountX, NoiseBasedChunkGenerator.this.cellCountY, NoiseBasedChunkGenerator.this.cellCountZ, p_158521_, p_158522_, NoiseBasedChunkGenerator.this.oreVeinifier::m_158827_);
            this.veinA = new NoiseInterpolator(NoiseBasedChunkGenerator.this.cellCountX, NoiseBasedChunkGenerator.this.cellCountY, NoiseBasedChunkGenerator.this.cellCountZ, p_158521_, p_158522_, NoiseBasedChunkGenerator.this.oreVeinifier::m_158843_);
            this.veinB = new NoiseInterpolator(NoiseBasedChunkGenerator.this.cellCountX, NoiseBasedChunkGenerator.this.cellCountY, NoiseBasedChunkGenerator.this.cellCountZ, p_158521_, p_158522_, NoiseBasedChunkGenerator.this.oreVeinifier::m_158849_);
            this.seed = p_158523_;
        }

...
public class RandomPatchConfiguration implements FeatureConfiguration
{
    ...
    public static class GrassConfigurationBuilder
    {
        ...
        public RandomPatchConfiguration.GrassConfigurationBuilder whitelist(Set<Block> pWhitelist)
        {
            this.whitelist = pWhitelist;
            return this;
        }

        public RandomPatchConfiguration.GrassConfigurationBuilder blacklist(Set<BlockState> pBlacklist)
        {
            this.blacklist = pBlacklist;
            return this;
        }

        public RandomPatchConfiguration.GrassConfigurationBuilder tries(int pTries)
        {
            this.tries = pTries;
            return this;
        }

        public RandomPatchConfiguration.GrassConfigurationBuilder xspread(int pXSpread)
        {
            this.xspread = pXSpread;
            return this;
        }

        public RandomPatchConfiguration.GrassConfigurationBuilder yspread(int pYSpread)
        {
            this.yspread = pYSpread;
            return this;
        }

        public RandomPatchConfiguration.GrassConfigurationBuilder zspread(int pZSpread)
        {
            this.zspread = pZSpread;
            return this;
        }

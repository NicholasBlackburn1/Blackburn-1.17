...
public class ProcessorRule
{
    ...
    public boolean test(BlockState p_74239_, BlockState p_74240_, BlockPos p_74241_, BlockPos p_74242_, BlockPos p_74243_, Random pRand)
    {
        return this.inputPredicate.test(p_74239_, pRand) && this.locPredicate.test(p_74240_, pRand) && this.posPredicate.test(p_74241_, p_74242_, p_74243_, pRand);
    }

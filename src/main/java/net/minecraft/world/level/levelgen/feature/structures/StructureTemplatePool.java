...
public class StructureTemplatePool
{
    ...
    public StructurePoolElement getRandomTemplate(Random pRand)
    {
        return this.templates.get(pRand.nextInt(this.templates.size()));
    }

    public List<StructurePoolElement> getShuffledTemplates(Random pRand)
    {
        return ImmutableList.copyOf(ObjectArrays.shuffle(this.templates.toArray(new StructurePoolElement[0]), pRand));
    }

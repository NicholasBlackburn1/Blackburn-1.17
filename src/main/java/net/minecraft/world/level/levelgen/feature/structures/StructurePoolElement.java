...
public abstract class StructurePoolElement
{
    ...
    public abstract List<StructureTemplate.StructureBlockInfo> getShuffledJigsawBlocks(StructureManager pTemplateManager, BlockPos pPos, Rotation pRotation, Random pRand);

    public abstract BoundingBox getBoundingBox(StructureManager pTemplateManager, BlockPos pPos, Rotation pRotation);
    ...
    public void handleDataMarker(LevelAccessor pLevel, StructureTemplate.StructureBlockInfo p_69159_, BlockPos pPos, Rotation pRotation, Random pRand, BoundingBox p_69163_)
    {
    }

    public StructurePoolElement setProjection(StructureTemplatePool.Projection pDecoratorBehaviour)
    {
        this.projection = pDecoratorBehaviour;
        return this;
    }

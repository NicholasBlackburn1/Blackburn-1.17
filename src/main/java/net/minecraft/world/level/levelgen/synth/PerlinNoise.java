...
public class PerlinNoise implements SurfaceNoise
{
    ...
    {
        return this.getValue(pX, p_75410_, pY, 0.0D, 0.0D, false);
    }
    ...
    public double getValue(double pX, double p_75419_, double pY, double p_75421_, double pZ, boolean p_75423_)
    {
        ...
        for (int i = 0; i < this.noiseLevels.length; ++i)
        {
            ...
            {
                double d3 = improvednoise.noise(wrap(pX * d1), p_75423_ ? -improvednoise.yo : wrap(p_75419_ * d1), wrap(pY * d1), p_75421_ * d1, pZ * d1);
    ...
    @Nullable
    public ImprovedNoise getOctaveNoise(int pOctaveIndex)
    {
        return this.noiseLevels[this.noiseLevels.length - 1 - pOctaveIndex];
    }
    ...
    public double getSurfaceNoiseValue(double pX, double p_75414_, double pY, double p_75416_)
    {
        return this.getValue(pX, p_75414_, 0.0D, pY, p_75416_, false);
    }
}

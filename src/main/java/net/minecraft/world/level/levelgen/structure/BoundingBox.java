...
public class BoundingBox
{
    ...
    public boolean intersects(BoundingBox pMinX)
    {
        return this.maxX >= pMinX.minX && this.minX <= pMinX.maxX && this.maxZ >= pMinX.minZ && this.minZ <= pMinX.maxZ && this.maxY >= pMinX.minY && this.minY <= pMinX.maxY;
    }
    ...
    public boolean isInside(Vec3i pVec)
    {
        return pVec.getX() >= this.minX && pVec.getX() <= this.maxX && pVec.getZ() >= this.minZ && pVec.getZ() <= this.maxZ && pVec.getY() >= this.minY && pVec.getY() <= this.maxY;
    }

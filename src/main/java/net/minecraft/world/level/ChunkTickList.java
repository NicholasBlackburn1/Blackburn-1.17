...
public class ChunkTickList<T> implements TickList<T> {
   ...
   public boolean hasScheduledTick(BlockPos p_45649_, T p_45650_) {
      return false;
   }

   public void scheduleTick(BlockPos p_45652_, T p_45653_, int p_45654_, TickPriority p_45655_) {
      this.ticks.add(new ChunkTickList.ScheduledTick<>(p_45653_, p_45652_, p_45654_, p_45655_));
   }

   public boolean willTickThisTick(BlockPos p_45662_, T p_45663_) {
      return false;
   }

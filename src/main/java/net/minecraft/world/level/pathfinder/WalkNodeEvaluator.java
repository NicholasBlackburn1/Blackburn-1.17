...
public class WalkNodeEvaluator extends NodeEvaluator
{
    ...
    {
        return this.collisionCache.computeIfAbsent(p_77635_, (p_77638_) ->
        {
            return !this.level.noCollision(this.mob, p_77635_);
        });
    }

    public BlockPathTypes getBlockPathType(BlockGetter pEntityliving, int pPos, int p_77596_, int p_77597_, Mob p_77598_, int p_77599_, int p_77600_, int p_77601_, boolean p_77602_, boolean p_77603_)
    {
        EnumSet<BlockPathTypes> enumset = EnumSet.noneOf(BlockPathTypes.class);
        BlockPathTypes blockpathtypes = BlockPathTypes.BLOCKED;
        BlockPos blockpos = p_77598_.blockPosition();
        blockpathtypes = this.getBlockPathTypes(pEntityliving, pPos, p_77596_, p_77597_, p_77599_, p_77600_, p_77601_, p_77602_, p_77603_, enumset, blockpathtypes, blockpos);
    ...
    public BlockPathTypes getBlockPathType(BlockGetter pEntityliving, int pPos, int p_77578_, int p_77579_)
    {
        return getBlockPathTypeStatic(pEntityliving, new BlockPos.MutableBlockPos(pPos, p_77578_, p_77579_));
    }

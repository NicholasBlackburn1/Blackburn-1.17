...
public class HopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {
   ...
   public CompoundTag save(CompoundTag p_59375_) {
      super.save(p_59375_);
      if (!this.trySaveLootTable(p_59375_)) {
         ContainerHelper.saveAllItems(p_59375_, this.items);
      }

      p_59375_.putInt("TransferCooldown", this.cooldownTime);
      return p_59375_;
   }

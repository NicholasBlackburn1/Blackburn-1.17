...
public class JigsawBlockEntity extends BlockEntity {
   ...
   public CompoundTag save(CompoundTag p_59434_) {
      super.save(p_59434_);
      p_59434_.putString("name", this.name.toString());
      p_59434_.putString("target", this.target.toString());
      p_59434_.putString("pool", this.pool.toString());
      p_59434_.putString("final_state", this.finalState);
      p_59434_.putString("joint", this.joint.getSerializedName());
      return p_59434_;
   }

...
public class BeaconBlockEntity extends BlockEntity implements MenuProvider {
   ...
   public CompoundTag save(CompoundTag p_58680_) {
      super.save(p_58680_);
      p_58680_.putInt("Primary", MobEffect.getId(this.primaryPower));
      p_58680_.putInt("Secondary", MobEffect.getId(this.secondaryPower));
      p_58680_.putInt("Levels", this.levels);
      if (this.name != null) {
         p_58680_.putString("CustomName", Component.Serializer.toJson(this.name));
      }

      this.lockKey.addToTag(p_58680_);
      return p_58680_;
   }

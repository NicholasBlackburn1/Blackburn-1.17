...
public class BeaconBlockEntity extends BlockEntity implements MenuProvider
{
    ...
    private final ContainerData dataAccess = new ContainerData()
    {
        ...
        public void set(int pIndex, int pValue)
        {
            ...
            {
                case 0:
                    BeaconBlockEntity.this.levels = pValue;
                    break;
                ...
                case 1:
                    ...
                    BeaconBlockEntity.this.primaryPower = BeaconBlockEntity.getValidEffectById(pValue);
                    break;

                case 2:
                    BeaconBlockEntity.this.secondaryPower = BeaconBlockEntity.getValidEffectById(pValue);
            }
        }
        public int getCount()
        {
    ...
    public CompoundTag save(CompoundTag pCompound)
    {
        ...
        pCompound.putInt("Primary", MobEffect.getId(this.primaryPower));
        pCompound.putInt("Secondary", MobEffect.getId(this.secondaryPower));
        pCompound.putInt("Levels", this.levels);
    ...
    public void setCustomName(@Nullable Component pAname)
    {
        this.name = pAname;
    }

...
public abstract class AbstractCauldronBlock extends Block
{
    ...
    protected static final VoxelShape SHAPE = Shapes.join(Shapes.block(), Shapes.m_83124_(box(0.0D, 0.0D, 4.0D, 16.0D, 3.0D, 12.0D), box(4.0D, 0.0D, 0.0D, 12.0D, 3.0D, 16.0D), box(2.0D, 0.0D, 2.0D, 14.0D, 3.0D, 14.0D), INSIDE), BooleanOp.ONLY_FIRST);

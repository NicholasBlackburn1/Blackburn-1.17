...
public abstract class BaseFireBlock extends Block
{
    ...
    public void animateTick(BlockState pState, Level pLevel, BlockPos pPos, Random pRand)
    {
        ...
        {
            pLevel.playLocalSound((double)pPos.getX() + 0.5D, (double)pPos.getY() + 0.5D, (double)pPos.getZ() + 0.5D, SoundEvents.FIRE_AMBIENT, SoundSource.BLOCKS, 1.0F + pRand.nextFloat(), pRand.nextFloat() * 0.7F + 0.3F, false);
        }

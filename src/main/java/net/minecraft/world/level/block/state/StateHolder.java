...
public abstract class StateHolder<O, S>
{
    ...
    protected static <T> T findNextInCollection(Collection<T> pAllowedValues, T p_61132_)
    {
        Iterator<T> iterator = pAllowedValues.iterator();
        ...
        while (iterator.hasNext())
        {
            if (iterator.next().equals(p_61132_))
            {
                ...
                return pAllowedValues.iterator().next();
            }
        }

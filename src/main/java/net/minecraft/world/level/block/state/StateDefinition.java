...
public class StateDefinition<O, S extends StateHolder<O, S>> {
   ...
   private static <S extends StateHolder<?, S>, T extends Comparable<T>> MapCodec<S> appendPropertyCodec(MapCodec<S> p_61077_, Supplier<S> p_61078_, String p_61079_, Property<T> p_61080_) {
      return Codec.mapPair(p_61077_, p_61080_.valueCodec().fieldOf(p_61079_).setPartial(() -> {
         return p_61080_.value(p_61078_.get());
      })).xmap((p_61069_) -> {
         return p_61069_.getFirst().setValue(p_61080_, p_61069_.getSecond().value());
      }, (p_61066_) -> {
         return Pair.of(p_61066_, p_61080_.value(p_61066_));
      });
   }

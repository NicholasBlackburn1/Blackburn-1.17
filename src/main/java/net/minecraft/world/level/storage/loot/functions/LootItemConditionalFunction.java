...
public abstract class LootItemConditionalFunction implements LootItemFunction
{
    ...
    protected LootItemConditionalFunction(LootItemCondition[] p_80678_)
    {
        ...
        this.compositePredicates = LootItemConditions.m_81834_(p_80678_);
    }
    ...
    public abstract static class Serializer<T extends LootItemConditionalFunction> implements net.minecraft.world.level.storage.loot.Serializer<T>
    {
        ...
        public final T deserialize(JsonObject pObject, JsonDeserializationContext pDeserializationContext)
        {
            LootItemCondition[] alootitemcondition = GsonHelper.getAsObject(pObject, "conditions", new LootItemCondition[0], pDeserializationContext, LootItemCondition[].class);
            return this.m_6821_(pObject, pDeserializationContext, alootitemcondition);
        }

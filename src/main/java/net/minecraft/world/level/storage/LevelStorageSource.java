...
public class LevelStorageSource
{
    ...
    private static DataPackConfig readDataPackConfig(Dynamic<?> pNbt)
    {
        return DataPackConfig.CODEC.parse(pNbt).resultOrPartial(LOGGER::error).orElse(DataPackConfig.DEFAULT);
    }
    ...
    public class LevelStorageAccess implements AutoCloseable
    {
        ...
        {
            this.checkLock();
            return LevelStorageSource.this.readLevelData(this.levelPath.toFile(), LevelStorageSource.getLevelData(pNbt, pDatapackCodec));
        }
        ...
        public void saveDataTag(RegistryAccess pRegistries, WorldData pServerConfiguration, @Nullable CompoundTag p_78293_)
        {
            File file1 = this.levelPath.toFile();
            CompoundTag compoundtag = pServerConfiguration.createTag(pRegistries, p_78293_);

...
public class LootItemEntityPropertyCondition implements LootItemCondition
{
    ...
    public static LootItemCondition.Builder hasProperties(LootContext.EntityTarget pTarget, EntityPredicate pPredicateBuilder)
    {
        return () ->
        {
            return new LootItemEntityPropertyCondition(pPredicateBuilder, pTarget);
        };
    }

...
public class CheckerboardColumnBiomeSource extends BiomeSource {
   ...
   public Biome getNoiseBiome(int p_48246_, int p_48247_, int p_48248_) {
      return this.allowedBiomes.get(Math.floorMod((p_48246_ >> this.bitShift) + (p_48248_ >> this.bitShift), this.allowedBiomes.size())).get();
   }
}
...
public class BiomeSpecialEffects
{
    ...
    public static class Builder
    {
        ...
        public BiomeSpecialEffects.Builder foliageColorOverride(int pFoliageColor)
        {
            this.foliageColorOverride = Optional.of(pFoliageColor);
            return this;
        }

        public BiomeSpecialEffects.Builder grassColorOverride(int pGrassColor)
        {
        ...
        public BiomeSpecialEffects.Builder ambientParticle(AmbientParticleSettings pParticle)
        {
            this.ambientParticle = Optional.of(pParticle);
            return this;
        }

        public BiomeSpecialEffects.Builder ambientLoopSound(SoundEvent pAmbientSound)
        {
            this.ambientLoopSoundEvent = Optional.of(pAmbientSound);
            return this;
        }

        public BiomeSpecialEffects.Builder ambientMoodSound(AmbientMoodSettings pMoodSound)
        {
            this.ambientMoodSettings = Optional.of(pMoodSound);
            return this;
        }

        public BiomeSpecialEffects.Builder ambientAdditionsSound(AmbientAdditionsSettings pAdditionsSound)
        {
            this.ambientAdditionsSettings = Optional.of(pAdditionsSound);
            return this;
        }

        public BiomeSpecialEffects.Builder backgroundMusic(Music pMusic)
        {
    ...
    public static enum GrassColorModifier implements StringRepresentable
    {
        NONE("none")
        {
            public int modifyColor(double pX, double p_48082_, int pZ)
            {
                return pZ;
            }
        },
        ...
        {
            public int modifyColor(double pX, double p_48090_, int pZ)
            {
                return (pZ & 16711422) + 2634762 >> 1;
            }
        },
        SWAMP("swamp")
        {
            public int modifyColor(double pX, double p_48098_, int pZ)
            {
                double d0 = Biome.BIOME_INFO_NOISE.getValue(pX * 0.0225D, p_48098_ * 0.0225D, false);
        ...
        public abstract int modifyColor(double pX, double p_48066_, int pZ);
        ...
        public static BiomeSpecialEffects.GrassColorModifier byName(String pName)
        {

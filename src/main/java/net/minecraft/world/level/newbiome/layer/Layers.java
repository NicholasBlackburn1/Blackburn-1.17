...
public class Layers implements LayerBiomes {
   ...
   private static <T extends Area, C extends BigContext<T>> AreaFactory<T> zoom(long p_76730_, AreaTransformer1 p_76731_, AreaFactory<T> p_76732_, int p_76733_, LongFunction<C> p_76734_) {
      AreaFactory<T> areafactory = p_76732_;

      for(int i = 0; i < p_76733_; ++i) {
         areafactory = p_76731_.run(p_76734_.apply(p_76730_ + (long)i), areafactory);
      }

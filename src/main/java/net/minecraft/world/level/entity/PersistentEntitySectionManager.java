...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable
{
    ...
    public void saveAll()
    {
        ...
        {
            this.permanentStorage.m_182219_(false);
            this.processPendingLoads();
        ...
        this.permanentStorage.m_182219_(true);
    }
        ...
        this.sectionStorage.getAllChunksWithExistingSections().forEach((long p_157517_) ->
        {
            ...
            this.sectionStorage.getExistingSectionPositionsInChunk(p_157517_).forEach((p_157521_) -> {
                ...
                if (entitysection != null)
                {
                    try
                    {
                        csvoutput.m_13624_(SectionPos.x(p_157521_), SectionPos.y(p_157521_), SectionPos.z(p_157521_), entitysection.getStatus(), persistententitysectionmanager$chunkloadstatus, entitysection.size());
                    }

...
public class EntitySectionStorage<T extends EntityAccess> {
   ...
   private static <T extends EntityAccess> Predicate<T> createBoundingBoxCheck(AABB p_156873_) {
      return (p_156876_) -> {
         return p_156876_.getBoundingBox().intersects(p_156873_);
      };
   }

   public void getEntities(AABB p_156891_, Consumer<T> p_156892_) {
      this.forEachAccessibleSection(p_156891_, (p_156883_) -> {
         p_156883_.getEntities(createBoundingBoxCheck(p_156891_), p_156892_);
      });
   }

   public <U extends T> void getEntities(EntityTypeTest<T, U> p_156864_, AABB p_156865_, Consumer<U> p_156866_) {
      this.forEachAccessibleSection(p_156865_, (p_156871_) -> {
         p_156871_.getEntities(p_156864_, createBoundingBoxCheck(p_156865_), p_156866_);
      });
   }

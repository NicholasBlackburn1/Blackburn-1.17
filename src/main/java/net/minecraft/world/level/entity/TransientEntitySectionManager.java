...
public class TransientEntitySectionManager<T extends EntityAccess>
{
    ...
    public TransientEntitySectionManager(Class<T> p_157643_, LevelCallback<T> p_157644_)
    {
        ...
        this.sectionStorage = new EntitySectionStorage<>(p_157643_, (p_175900_1_) ->
        {
            return this.tickingChunks.contains(p_175900_1_) ? Visibility.TICKING : Visibility.TRACKED;
        });
    ...
    public void startTicking(ChunkPos p_157652_)
    {
        ...
        this.sectionStorage.getExistingSectionsInChunk(i).forEach((p_175922_1_) ->
        {
            Visibility visibility = p_175922_1_.updateChunkStatus(Visibility.TICKING);

            if (!visibility.isTicking())
            {
                p_175922_1_.getEntities().filter((p_307590_0_) ->
                {
                    return !p_307590_0_.isAlwaysTicking();
    ...
    public void stopTicking(ChunkPos p_157659_)
    {
        ...
        this.sectionStorage.getExistingSectionsInChunk(i).forEach((p_175909_1_) ->
        {
            Visibility visibility = p_175909_1_.updateChunkStatus(Visibility.TRACKED);

            if (visibility.isTicking())
            {
                p_175909_1_.getEntities().filter((p_307588_0_) ->
                {
                    return !p_307588_0_.isAlwaysTicking();

...
public abstract class VoxelShape
{
    ...
    public VoxelShape move(double pXOffset, double p_83218_, double pYOffset)
    {
        return (VoxelShape)(this.isEmpty() ? Shapes.empty() : new ArrayVoxelShape(this.shape, (DoubleList)(new OffsetDoubleList(this.getCoords(Direction.Axis.X), pXOffset)), (DoubleList)(new OffsetDoubleList(this.getCoords(Direction.Axis.Y), p_83218_)), (DoubleList)(new OffsetDoubleList(this.getCoords(Direction.Axis.Z), pYOffset))));
    }
    ...
    public double min(Direction.Axis pAxis, double p_166080_, double p_166081_)
    {
    ...
    public double max(Direction.Axis pAxis, double p_83292_, double p_83293_)
    {
        Direction.Axis direction$axis = AxisCycle.FORWARD.cycle(pAxis);
        Direction.Axis direction$axis1 = AxisCycle.BACKWARD.cycle(pAxis);

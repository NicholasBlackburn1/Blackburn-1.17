            ...
            for(int l = 0; l <= bitsetdiscretevoxelshape.zSize; ++l) {
               if (bitsetdiscretevoxelshape.isFullWide(i, j, l)) {
                  if (p_165966_) {
                     ...
                     p_165965_.consume(i, j, l, i + 1, j + 1, l + 1);
                  }
               } else if (k != -1) {
                  int i1 = i;
                  int j1 = j;
                  ...
                  while(bitsetdiscretevoxelshape.isZStripFull(k, l, i1 + 1, j)) {
                     bitsetdiscretevoxelshape.clearZStrip(k, l, i1 + 1, j);
                     ++i1;
                  }

                  while(bitsetdiscretevoxelshape.isXZRectangleFull(i, i1 + 1, k, l, j1 + 1)) {
                  ...
                  p_165965_.consume(i, j, k, i1 + 1, j1 + 1, l);
                  k = -1;
               }
            }
         }

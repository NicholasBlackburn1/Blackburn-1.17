...
public class EnderDragon extends Mob implements Enemy
{
    ...
    public double[] getLatencyPos(int p_31102_, float pPartialTicks)
    {
    ...
    public boolean hurt(EnderDragonPart pEntities, DamageSource p_31122_, float p_31123_)
    {
    ...
    public boolean hurt(DamageSource pEntities, float p_31114_)
    {
        if (pEntities instanceof EntityDamageSource && ((EntityDamageSource)pEntities).isThorns())
        {
            this.hurt(this.body, pEntities, p_31114_);
        }
    ...
    public void onCrystalDestroyed(EndCrystal pCrystal, BlockPos pPos, DamageSource pDmgSrc)
    {
        ...
        if (pDmgSrc.getEntity() instanceof Player)
        {
            player = (Player)pDmgSrc.getEntity();
        }
        else
        {

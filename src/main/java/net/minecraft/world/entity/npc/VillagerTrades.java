...
public class VillagerTrades
{
    ...
    static class SuspisciousStewForEmerald implements VillagerTrades.ItemListing
    {
        ...
        {
            this.effect = p_35778_;
            this.duration = p_35779_;
            this.xp = p_35780_;
            this.priceMultiplier = 0.05F;
        }
    ...
    static class TreasureMapForEmeralds implements VillagerTrades.ItemListing
    {
        ...
        public MerchantOffer getOffer(Entity pTrader, Random pRand)
        {
            ...
            else
            {
                ...
                BlockPos blockpos = serverlevel.findNearestMapFeature(this.destination, pTrader.blockPosition(), 100, true);

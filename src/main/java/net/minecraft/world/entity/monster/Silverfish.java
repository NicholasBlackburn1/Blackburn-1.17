...
public class Silverfish extends Monster {
   ...
   public static boolean checkSliverfishSpawnRules(EntityType<Silverfish> p_33534_, LevelAccessor p_33535_, MobSpawnType p_33536_, BlockPos p_33537_, Random p_33538_) {
      if (checkAnyLightMonsterSpawnRules(p_33534_, p_33535_, p_33536_, p_33537_, p_33538_)) {
         Player player = p_33535_.getNearestPlayer((double)p_33537_.getX() + 0.5D, (double)p_33537_.getY() + 0.5D, (double)p_33537_.getZ() + 0.5D, 5.0D, true);
         return player == null;
      } else {
         return false;
      }

...
public class HoglinAi {
   ...
   private static void retreatFromNearestTarget(Hoglin p_34613_, LivingEntity p_34614_) {
      ...
      LivingEntity livingentity = BehaviorUtils.getNearestTarget(p_34613_, brain.getMemory(MemoryModuleType.AVOID_TARGET), p_34614_);
      livingentity = BehaviorUtils.getNearestTarget(p_34613_, brain.getMemory(MemoryModuleType.ATTACK_TARGET), livingentity);
      setAvoidTarget(p_34613_, livingentity);
   }

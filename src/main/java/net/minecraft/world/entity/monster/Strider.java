...
public class Strider extends Animal implements ItemSteerable, Saddleable
{
    ...
    private static final Ingredient FOOD_ITEMS = Ingredient.m_43929_(Items.WARPED_FUNGUS);
    private static final Ingredient TEMPT_ITEMS = Ingredient.m_43929_(Items.WARPED_FUNGUS, Items.WARPED_FUNGUS_ON_A_STICK);

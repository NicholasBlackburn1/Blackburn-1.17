...
public class PiglinAi {
   ...
   private static void retreatFromNearestTarget(Piglin p_34950_, LivingEntity p_34951_) {
      ...
      LivingEntity livingentity = BehaviorUtils.getNearestTarget(p_34950_, brain.getMemory(MemoryModuleType.AVOID_TARGET), p_34951_);
      livingentity = BehaviorUtils.getNearestTarget(p_34950_, brain.getMemory(MemoryModuleType.ATTACK_TARGET), livingentity);
      setAvoidTargetAndDontHuntForAWhile(p_34950_, livingentity);
   }

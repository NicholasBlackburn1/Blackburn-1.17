...
public class Pillager extends AbstractIllager implements CrossbowAttackMob, InventoryCarrier {
   ...
   public float getWalkTargetValue(BlockPos p_33288_, LevelReader p_33289_) {
      BlockState blockstate = p_33289_.getBlockState(p_33288_.below());
      return !blockstate.is(Blocks.GRASS_BLOCK) && !blockstate.is(Blocks.SAND) ? 0.5F - p_33289_.getBrightness(p_33288_) : 10.0F;
   }

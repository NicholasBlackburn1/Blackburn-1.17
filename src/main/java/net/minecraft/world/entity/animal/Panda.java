...
public class Panda extends Animal
{
    ...
    private void setFlag(int pFlagId, boolean p_29136_)
    {
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.0D, Ingredient.m_43929_(Blocks.BAMBOO.asItem()), false));
        ...
        this.targetSelector.addGoal(1, (new Panda.PandaHurtByTargetGoal(this)).m_26044_(new Class[0]));
    }
    ...
    public static enum Gene
    {
        ...
        public static Panda.Gene getRandom(Random pRand)
        {

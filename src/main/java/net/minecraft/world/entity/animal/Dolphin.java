...
public class Dolphin extends WaterAnimal
{
    ...
    protected void registerGoals()
    {
        ...
        this.targetSelector.addGoal(1, (new HurtByTargetGoal(this, Guardian.class)).m_26044_());
    }
    ...
    public static boolean checkDolphinSpawnRules(EntityType<Dolphin> p_28346_, LevelAccessor p_28347_, MobSpawnType p_28348_, BlockPos p_28349_, Random p_28350_)
    {
        if (p_28349_.getY() > 45 && p_28349_.getY() < p_28347_.getSeaLevel())
        {
            Optional<ResourceKey<Biome>> optional = p_28347_.getBiomeName(p_28349_);
            return (!Objects.equals(optional, Optional.of(Biomes.OCEAN)) || !Objects.equals(optional, Optional.of(Biomes.DEEP_OCEAN))) && p_28347_.getFluidState(p_28349_).is(FluidTags.WATER);
        }
        else
        {
            return false;
    ...
    static class DolphinSwimToTreasureGoal extends Goal
    {
        ...
        public void start()
        {
            if (this.dolphin.level instanceof ServerLevel)
            {
                ...
                BlockPos blockpos1 = serverlevel.findNearestMapFeature(structurefeature, blockpos, 50, false);

                if (blockpos1 == null)
                {
                    StructureFeature<?> structurefeature1 = structurefeature.equals(StructureFeature.OCEAN_RUIN) ? StructureFeature.SHIPWRECK : StructureFeature.OCEAN_RUIN;
                    BlockPos blockpos2 = serverlevel.findNearestMapFeature(structurefeature1, blockpos, 50, false);

...
public class TropicalFish extends AbstractSchoolingFish
{
    ...
    private static int calculateVariant(TropicalFish.Pattern pType, DyeColor pPattern, DyeColor pBodyColor)
    {
        return pType.getBase() & 255 | (pType.getIndex() & 255) << 8 | (pPattern.getId() & 255) << 16 | (pBodyColor.getId() & 255) << 24;
    }
    ...
    {
        return Math.min((p_30065_ & 65280) >> 8, 5);
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag)
    {
        ...
        else
        {
            ...
            {
                int i1 = Util.m_137542_(COMMON_VARIANTS, this.random);
                i = i1 & 255;
                j = (i1 & 65280) >> 8;
                k = (i1 & 16711680) >> 16;
                l = (i1 & -16777216) >> 24;

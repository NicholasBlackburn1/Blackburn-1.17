...
public class Pig extends Animal implements ItemSteerable, Saddleable
{
    ...
    private static final Ingredient FOOD_ITEMS = Ingredient.m_43929_(Items.CARROT, Items.POTATO, Items.BEETROOT);
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.2D, Ingredient.m_43929_(Items.CARROT_ON_A_STICK), false));

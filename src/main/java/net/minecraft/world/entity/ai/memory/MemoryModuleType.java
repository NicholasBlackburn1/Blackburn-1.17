...
public class MemoryModuleType<U>
{
    ...
    private MemoryModuleType(Optional<Codec<U>> p_26386_)
    {
    ...
    private static <U> MemoryModuleType<U> register(String pIdentifier, Codec<U> p_26392_)
    {
        return Registry.register(Registry.MEMORY_MODULE_TYPE, new ResourceLocation(pIdentifier), new MemoryModuleType<>(Optional.of(p_26392_)));
    }

    private static <U> MemoryModuleType<U> register(String pIdentifier)
    {
        return Registry.register(Registry.MEMORY_MODULE_TYPE, new ResourceLocation(pIdentifier), new MemoryModuleType<>(Optional.empty()));
    }
}

...
public class Bat extends AmbientCreature
{
    ...
    protected void checkFallDamage(double pY, boolean p_27420_, BlockState pOnGround, BlockPos pState)
    {
    }
    ...
    public static boolean checkBatSpawnRules(EntityType<Bat> pBat, LevelAccessor pLevel, MobSpawnType pReason, BlockPos pPos, Random pRandom)
    {
        ...
        else
        {
            ...
            return i > pRandom.nextInt(j) ? false : checkMobSpawnRules(pBat, pLevel, pReason, pPos, pRandom);
        }
    }

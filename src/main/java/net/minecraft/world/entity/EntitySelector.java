...
public final class EntitySelector
{
    ...
    public static Predicate<Entity> withinDistance(double pX, double p_20412_, double pY, double p_20414_)
    {
        double d0 = p_20414_ * p_20414_;
        return (p_20420_) ->
        {
            return p_20420_ != null && p_20420_.distanceToSqr(pX, p_20412_, pY) <= d0;
        };
    }

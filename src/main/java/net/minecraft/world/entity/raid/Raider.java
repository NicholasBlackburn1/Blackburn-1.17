...
public abstract class Raider extends PatrollingMonster
{
    ...
    public abstract void applyRaidBuffs(int pWave, boolean p_37845_);
    ...
    public void setCanJoinRaid(boolean pCanJoin)
    {
        this.canJoinRaid = pCanJoin;
    }
    ...
    public void setCelebrating(boolean pCelebrate)
    {
        this.entityData.set(IS_CELEBRATING, pCelebrate);
    }
    ...
    public void setTicksOutsideRaid(int pDelay)
    {
        this.ticksOutsideRaid = pDelay;
    }

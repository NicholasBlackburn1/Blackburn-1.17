...
public abstract class AbstractArrow extends Projectile
{
    ...
    public void shoot(double pX, double p_36776_, double pY, float p_36778_, float pZ)
    {
        super.shoot(pX, p_36776_, pY, p_36778_, pZ);
        this.life = 0;
    }

    public void lerpTo(double pX, double p_36729_, double pY, float p_36731_, float pZ, int p_36733_, boolean pYaw)
    {
        this.setPos(pX, p_36729_, pY);
        this.setRot(p_36731_, pZ);
    }

    public void lerpMotion(double pX, double p_36787_, double pY)
    {
        super.lerpMotion(pX, p_36787_, pY);
        this.life = 0;
    }

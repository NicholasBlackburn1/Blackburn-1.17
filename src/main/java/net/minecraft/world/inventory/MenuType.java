...
public class MenuType<T extends AbstractContainerMenu>
{
    ...
    {
        return Registry.register(Registry.MENU, pKey, new MenuType<>(pFactory));
    }

    private MenuType(MenuType.MenuSupplier<T> p_39984_)
    {
        this.constructor = p_39984_;
    }

    public T create(int pWindowId, Inventory pPlayer)
    {
        return this.constructor.create(pWindowId, pPlayer);
    }

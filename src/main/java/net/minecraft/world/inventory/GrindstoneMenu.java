...
public class GrindstoneMenu extends AbstractContainerMenu
{
    ...
    public GrindstoneMenu(int p_39566_, Inventory p_39567_, final ContainerLevelAccess p_39568_)
    {
        ...
        this.addSlot(new Slot(this.repairSlots, 0, 49, 19)
        {
            ...
            {
                return pStack.isDamageableItem() || pStack.is(Items.ENCHANTED_BOOK) || pStack.isEnchanted();
            }
        });
        ...
        this.addSlot(new Slot(this.resultSlots, 2, 129, 34)
        {
            ...
            {
                int l = 0;
                l = l + this.getExperienceFromItem(GrindstoneMenu.this.repairSlots.getItem(0));
                l = l + this.getExperienceFromItem(GrindstoneMenu.this.repairSlots.getItem(1));

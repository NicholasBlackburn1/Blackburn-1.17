...
public abstract class AbstractContainerMenu
{
    ...
    protected static boolean stillValid(ContainerLevelAccess p_38890_, Player pPlayer, Block p_38892_)
    {
        return p_38890_.evaluate((p_38916_, p_38917_) ->
        {
            return !p_38916_.getBlockState(p_38917_).is(p_38892_) ? false : pPlayer.distanceToSqr((double)p_38917_.getX() + 0.5D, (double)p_38917_.getY() + 0.5D, (double)p_38917_.getZ() + 0.5D) <= 64.0D;
        }, true);
    }
    ...
    public void sendAllDataToRemote()
    {
        ...
        {
            this.synchronizer.m_142589_(this, this.remoteSlots, this.remoteCarried, this.remoteDataSlots.toIntArray());
        }
    }

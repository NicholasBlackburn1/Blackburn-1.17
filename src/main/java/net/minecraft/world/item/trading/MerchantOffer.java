...
public class MerchantOffer
{
    ...
    private boolean isRequiredItem(ItemStack pLeft, ItemStack pRight)
    {
        if (pRight.isEmpty() && pLeft.isEmpty())
        {
            return true;
        }
        else
        {
            ItemStack itemstack = pLeft.copy();
            ...
            return ItemStack.isSame(itemstack, pRight) && (!pRight.hasTag() || itemstack.hasTag() && NbtUtils.compareNbt(pRight.getTag(), itemstack.getTag(), false));
        }
    }

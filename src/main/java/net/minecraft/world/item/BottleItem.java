...
public class BottleItem extends Item
{
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand)
    {
        ...
        if (!list.isEmpty())
        {
            ...
            pLevel.gameEvent(pPlayer, GameEvent.FLUID_PICKUP, pPlayer.blockPosition());
    ...
    protected ItemStack turnBottleIntoItem(ItemStack pBottleStack, Player pPlayer, ItemStack pStack)
    {
        pPlayer.awardStat(Stats.ITEM_USED.get(this));
        return ItemUtils.createFilledResult(pBottleStack, pPlayer, pStack);
    }
}

...
{
    private static final Ingredient SHAPE_INGREDIENT = Ingredient.m_43929_(Items.FIRE_CHARGE, Items.FEATHER, Items.GOLD_NUGGET, Items.SKELETON_SKULL, Items.WITHER_SKELETON_SKULL, Items.CREEPER_HEAD, Items.PLAYER_HEAD, Items.DRAGON_HEAD, Items.ZOMBIE_HEAD);
    private static final Ingredient TRAIL_INGREDIENT = Ingredient.m_43929_(Items.DIAMOND);
    private static final Ingredient FLICKER_INGREDIENT = Ingredient.m_43929_(Items.GLOWSTONE_DUST);

...
public abstract class CreativeModeTab
{
    ...
    public CreativeModeTab setBackgroundSuffix(String pTexture)
    {
        this.backgroundSuffix = pTexture;
        return this;
    }

    public CreativeModeTab setRecipeFolderName(String pPath)
    {
        this.recipeFolderName = pPath;
        return this;
    }
    ...
    public boolean hasEnchantmentCategory(@Nullable EnchantmentCategory pEnchantmentType)
    {
        if (pEnchantmentType != null)
        {
            for (EnchantmentCategory enchantmentcategory : this.enchantmentCategories)
            {
                if (enchantmentcategory == pEnchantmentType)
                {
                    return true;
                }
            }

...
public final class RegistryDataPackCodec<E> implements Codec<MappedRegistry<E>>
{
    ...
    public static <E> RegistryDataPackCodec<E> create(ResourceKey <? extends Registry<E >> pRegistryKey, Lifecycle pLifecycle, Codec<E> pRawCodec)
    {
        return new RegistryDataPackCodec<>(pRegistryKey, pLifecycle, pRawCodec);
    }

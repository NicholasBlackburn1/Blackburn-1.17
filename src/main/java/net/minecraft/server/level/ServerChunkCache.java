...
public class ServerChunkCache extends ChunkSource {
   ...
   private boolean checkChunkFuture(long p_8374_, Function<ChunkHolder, CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>>> p_8375_) {
      ChunkHolder chunkholder = this.getVisibleChunkIfPresent(p_8374_);
      if (chunkholder == null) {
         return false;
      } else {

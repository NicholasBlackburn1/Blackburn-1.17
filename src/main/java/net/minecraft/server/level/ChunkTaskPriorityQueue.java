...
public class ChunkTaskPriorityQueue<T>
{
    ...
    protected void submit(Optional<T> pTask, long pChunkPos, int p_140538_)
    {
        this.taskQueue.get(p_140538_).computeIfAbsent(pChunkPos, (p_140545_) ->
        {
            return Lists.newArrayList();
        }).add(pTask);
    ...
    protected void release(long pChunkPos, boolean p_140532_)
    {

...
public class ServerFunctionManager
{
    ...
    public int execute(CommandFunction pFunctionObject, CommandSourceStack pSource, @Nullable ServerFunctionManager.TraceCallbacks p_179963_)
    {
    ...
    {
        this.ticking = ImmutableList.copyOf(pReloader.getTags().getTagOrEmpty(TICK_FUNCTION_TAG).getValues());
    ...
    public Tag<CommandFunction> getTag(ResourceLocation pFunctionTagIdentifier)
    {

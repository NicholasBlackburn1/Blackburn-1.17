...
public class RconClient extends GenericThread
{
    ...
    {
        {
            try
            {
                while (true)
                {
                    ...
                    {
                        int j = 0;
                        int k = PktUtils.m_11492_(this.buf, 0, i);
                        ...
                        j = j + 4;
                        int l = PktUtils.m_11492_(this.buf, j, i);
                        j = j + 4;
                        int i1 = PktUtils.m_11485_(this.buf, j);
                        j = j + 4;
                        ...
                        switch (i1)
                        {
                            case 2:
                                if (this.authed)
                                {
                                    String s1 = PktUtils.m_11488_(this.buf, j, i);
                            ...
                            case 3:
                                String s = PktUtils.m_11488_(this.buf, j, i);
                                int j1 = j + s.length();
    ...
    private void send(int p_11591_, int p_11592_, String pMessage) throws IOException
    {

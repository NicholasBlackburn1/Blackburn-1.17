...
public class QueryThreadGs4 extends GenericThread
{
        ...
        if (3 <= i && -2 == abyte[0] && -3 == abyte[1])
        {
            ...
            switch (abyte[2])
            {
                case 0:
                    ...
                    {
                        this.m_11555_(this.buildRuleResponse(pRequestPacket), pRequestPacket);
                    ...
                    else
                    {
                        ...
                        networkdataoutputstream.m_11478_(this.getIdentBytes(pRequestPacket.getSocketAddress()));
                        ...
                        this.m_11555_(networkdataoutputstream.toByteArray(), pRequestPacket);
    ...
    private byte[] buildRuleResponse(DatagramPacket pRequestPacket) throws IOException
    {
        ...
        else
        {
            ...
            this.rulesResponse.m_11478_(this.getIdentBytes(pRequestPacket.getSocketAddress()));
    ...
    private Boolean validChallenge(DatagramPacket pRequestPacket)
    {
        ...
        {
            byte[] abyte = pRequestPacket.getData();
            return this.validChallenges.get(socketaddress).getChallenge() == PktUtils.m_11496_(abyte, 7, pRequestPacket.getLength());
        }
    }
    ...
    private void sendChallenge(DatagramPacket pRequestPacket) throws IOException
    {
        ...
        this.m_11555_(querythreadgs4$requestchallenge.getChallengeBytes(), pRequestPacket);
    }

...
public abstract class Settings<T extends Settings<T>>
{
    ...
    protected <V> V get(String pKey, Function<String, V> p_139823_, Function<V, String> p_139824_, V p_139825_)
    {
        String s = this.getStringRaw(pKey);
        V v = MoreObjects.firstNonNull((V)(s != null ? p_139823_.apply(s) : null), p_139825_);
        this.properties.put(pKey, p_139824_.apply(v));
        return v;
    }
    ...
    protected <V> V get(String pKey, Function<String, V> p_139828_, UnaryOperator<V> p_139829_, Function<V, String> p_139830_, V p_139831_)
    {
    ...
    protected <V> V get(String pKey, Function<String, V> p_139819_, V p_139820_)
    {
        return this.get(pKey, p_139819_, Objects::toString, p_139820_);
    }
    ...
    protected int get(String pKey, UnaryOperator<Integer> p_139834_, int p_139835_)
    {
        return this.get(pKey, wrapNumberDeserializer(Integer::parseInt), p_139834_, Objects::toString, p_139835_);
    }

    protected long get(String pKey, long p_139810_)
    {
        return this.get(pKey, wrapNumberDeserializer(Long::parseLong), p_139810_);
    }

...
public class SpreadPlayersCommand
{
    ...
    private static int spreadPlayers(CommandSourceStack p_138703_, Vec2 p_138704_, float p_138705_, float p_138706_, int p_138707_, boolean p_138708_, Collection <? extends Entity > p_138709_) throws CommandSyntaxException
    {
        ...
        m_138710_(p_138704_, (double)p_138705_, p_138703_.getLevel(), random, d0, d1, d2, d3, p_138707_, aspreadplayerscommand$position, p_138708_);
        double d4 = m_138729_(p_138709_, p_138703_.getLevel(), aspreadplayerscommand$position, p_138707_, p_138708_);
    ...
    private static SpreadPlayersCommand.Position[] createInitialPositions(Random pRandom, int pCount, double pMinX, double p_138739_, double pMinZ, double p_138741_)
    {
    ...
    static class Position
    {
        ...
        public int getSpawnY(BlockGetter pLevel, int p_138760_)
        {

...
public class SetWorldSpawnCommand
{
    ...
    private static int setSpawn(CommandSourceStack pSource, BlockPos pPos, float p_138669_)
    {
        pSource.getLevel().setDefaultSpawnPos(pPos, p_138669_);
        pSource.sendSuccess(new TranslatableComponent("commands.setworldspawn.success", pPos.getX(), pPos.getY(), pPos.getZ(), p_138669_), true);
        return 1;
    }
}

...
public class DataCommands
{
    ...
    private static int getData(CommandSourceStack pSource, DataAccessor pAccessor, NbtPathArgument.NbtPath p_139446_) throws CommandSyntaxException
    {
        Tag tag = getSingleTag(p_139446_, pAccessor);
        int i;

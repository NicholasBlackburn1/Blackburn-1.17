...
public class WorldBorderCommand
{
    ...
    private static int setDamageBuffer(CommandSourceStack pSource, float pDistance) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(new TranslatableComponent("commands.worldborder.damage.buffer.success", String.format(Locale.ROOT, "%.2f", pDistance)), true);
    ...
    private static int setDamageAmount(CommandSourceStack pSource, float pDamagePerBlock) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(new TranslatableComponent("commands.worldborder.damage.amount.success", String.format(Locale.ROOT, "%.2f", pDamagePerBlock)), true);
    ...
    private static int setCenter(CommandSourceStack pSource, Vec2 pPos) throws CommandSyntaxException
    {
        ...
        else
        {
            ...
            pSource.sendSuccess(new TranslatableComponent("commands.worldborder.center.success", String.format(Locale.ROOT, "%.2f", pPos.x), String.format("%.2f", pPos.y)), true);
            return 0;
        }
    }

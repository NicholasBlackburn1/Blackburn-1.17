...
public class Pack implements AutoCloseable
{
    ...
    @Nullable
    public static Pack create(String pName, boolean p_10432_, Supplier<PackResources> p_10433_, Pack.PackConstructor pFactory, Pack.Position p_10435_, PackSource p_10436_)
    {
        try
        {
            ...
            label54:
            {
                try
                {
                    ...
                    {
                        pack = pFactory.create(pName, new TextComponent(packresources.getName()), p_10432_, p_10433_, packmetadatasection, p_10435_, p_10436_);
                        break label54;
                    }

                    LOGGER.warn("Couldn't find pack meta for pack {}", (Object)pName);
                }

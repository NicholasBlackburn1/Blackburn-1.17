...
public abstract class AbstractPackResources implements PackResources {
   ...
   public static <T> T getMetadataFromStream(MetadataSectionSerializer<T> p_10215_, InputStream p_10216_) {
      ...
      try {
         ...
         LOGGER.error("Couldn't load {} metadata", p_10215_.getMetadataSectionName(), ioexception);
         return (T)null;
      }
      ...
      if (!jsonobject.has(p_10215_.getMetadataSectionName())) {
         ...
         try {
            ...
            LOGGER.error("Couldn't load {} metadata", p_10215_.getMetadataSectionName(), jsonparseexception);
            return (T)null;
         }
      }
   }

...
public class SortedArraySet<T> extends AbstractSet<T>
{
    ...
    private SortedArraySet(int p_14244_, Comparator<T> p_14245_)
    {
        ...
        {
            this.contents = (T[])m_14258_(new Object[p_14244_]);
        }
    }
    ...
    public static <T> SortedArraySet<T> create(Comparator<T> pInitialCapacity)
    {
        return create(pInitialCapacity, 10);
    }

    public static <T> SortedArraySet<T> create(Comparator<T> pInitialCapacity, int p_144980_)
    {
        return new SortedArraySet<>(p_144980_, pInitialCapacity);
    }
    ...
    private void grow(int p_14268_)
    {
        if (p_14268_ > this.contents.length)
        {
            ...
            this.contents = (T[])m_14258_(aobject);
        }
    }

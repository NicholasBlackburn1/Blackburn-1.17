...
public interface FormattedCharSequence
{
    ...
    static FormattedCharSequence forward(String pString, Style pStyle)
    {
        return pString.isEmpty() ? EMPTY : (p_13739_) ->
        {
            return StringDecomposer.iterate(pString, pStyle, p_13739_);
        };
    }

    static FormattedCharSequence forward(String pString, Style pStyle, Int2IntFunction p_144720_)
    {
        return pString.isEmpty() ? EMPTY : (p_144730_) ->
        {
            return StringDecomposer.iterate(pString, pStyle, decorateOutput(p_144730_, p_144720_));
        };
    }

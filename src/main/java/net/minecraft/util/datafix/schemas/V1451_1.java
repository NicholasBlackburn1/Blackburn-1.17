...
public class V1451_1 extends NamespacedSchema
{
    ...
    public void registerTypes(Schema p_17432_, Map<String, Supplier<TypeTemplate>> p_17433_, Map<String, Supplier<TypeTemplate>> p_17434_)
    {
        ...
        {
            return DSL.fields("Level", DSL.optionalFields("Entities", DSL.list(References.ENTITY_TREE.in(p_17432_)), "TileEntities", DSL.list(References.BLOCK_ENTITY.in(p_17432_)), "TileTicks", DSL.list(DSL.fields("i", References.BLOCK_NAME.in(p_17432_))), "Sections", DSL.list(DSL.optionalFields("Palette", DSL.list(References.BLOCK_STATE.in(p_17432_))))));
        });
    }
}

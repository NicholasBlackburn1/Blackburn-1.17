...
public class V1466 extends NamespacedSchema
{
    ...
    public void registerTypes(Schema p_17694_, Map<String, Supplier<TypeTemplate>> p_17695_, Map<String, Supplier<TypeTemplate>> p_17696_)
    {
        ...
        {
            return DSL.fields("Level", DSL.optionalFields("Entities", DSL.list(References.ENTITY_TREE.in(p_17694_)), "TileEntities", DSL.list(References.BLOCK_ENTITY.in(p_17694_)), "TileTicks", DSL.list(DSL.fields("i", References.BLOCK_NAME.in(p_17694_))), "Sections", DSL.list(DSL.optionalFields("Palette", DSL.list(References.BLOCK_STATE.in(p_17694_)))), "Structures", DSL.optionalFields("Starts", DSL.compoundList(References.STRUCTURE_FEATURE.in(p_17694_)))));
        });

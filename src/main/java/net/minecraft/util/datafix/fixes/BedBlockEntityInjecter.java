...
public class BedBlockEntityInjecter extends DataFix {
   ...
   private <TE> TypeRewriteRule cap(Type<?> p_14710_, ListType<TE> p_14711_) {
      Type<TE> type = p_14711_.getElement();
      OpticFinder<?> opticfinder = DSL.fieldFinder("Level", p_14710_);
      OpticFinder<List<TE>> opticfinder1 = DSL.fieldFinder("TileEntities", p_14711_);
      int i = 416;

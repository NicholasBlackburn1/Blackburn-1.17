...
public class ClientboundLightUpdatePacket implements Packet<ClientGamePacketListener>
{
    ...
    {
        pBuf.writeVarInt(this.x);
        pBuf.writeVarInt(this.z);
        pBuf.writeBoolean(this.trustEdges);
        pBuf.writeBitSet(this.skyYMask);
        pBuf.writeBitSet(this.blockYMask);
        pBuf.writeBitSet(this.emptySkyYMask);
        pBuf.writeBitSet(this.emptyBlockYMask);
        pBuf.writeCollection(this.skyUpdates, FriendlyByteBuf::m_130087_);
        pBuf.writeCollection(this.blockUpdates, FriendlyByteBuf::m_130087_);
    }

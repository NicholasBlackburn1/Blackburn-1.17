...
public abstract class ClientboundMoveEntityPacket implements Packet<ClientGamePacketListener>
{
    ...
    public static double packetToEntity(long pX)
    {
        return (double)pX / 4096.0D;
    }
    ...
    public static class Pos extends ClientboundMoveEntityPacket
    {
        ...
        public void write(FriendlyByteBuf pBuf)
        {
            ...
            pBuf.writeShort(this.xa);
            pBuf.writeShort(this.ya);
            pBuf.writeShort(this.za);
            pBuf.writeBoolean(this.onGround);
        }
    }

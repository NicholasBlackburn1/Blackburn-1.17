...
public class ClientboundMerchantOffersPacket implements Packet<ClientGamePacketListener>
{
    ...
    {
        pBuf.writeVarInt(this.containerId);
        this.offers.writeToStream(pBuf);
        pBuf.writeVarInt(this.villagerLevel);
        pBuf.writeVarInt(this.villagerXp);
        pBuf.writeBoolean(this.showProgress);
        pBuf.writeBoolean(this.canRestock);
    }

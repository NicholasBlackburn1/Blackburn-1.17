...
public abstract class SimpleCriterionTrigger<T extends AbstractCriterionTriggerInstance> implements CriterionTrigger<T>
{
    ...
    protected abstract T createInstance(JsonObject pObject, EntityPredicate.Composite pConditions, DeserializationContext p_66250_);
    ...
    protected void trigger(ServerPlayer pServerPlayer, Predicate<T> pTestTrigger)
    {

...
public class LocationPredicate
{
    ...
    {
        return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, pBiome, (StructureFeature<?>)null, (ResourceKey<Level>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }

    public static LocationPredicate inDimension(ResourceKey<Level> pDimension)
    {
        return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, (ResourceKey<Biome>)null, (StructureFeature<?>)null, pDimension, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }

    public static LocationPredicate inFeature(StructureFeature<?> pFeature)
    {
        return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, (ResourceKey<Biome>)null, pFeature, (ResourceKey<Level>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }
    ...
    public boolean matches(ServerLevel pLevel, double pX, double p_52620_, double pY)
    {
        ...
        else
        {
            ...
            Optional<ResourceKey<Biome>> optional = pLevel.registryAccess().registryOrThrow(Registry.BIOME_REGISTRY).getResourceKey(pLevel.getBiome(blockpos));
            ...
            {
                if (this.feature == null || flag && pLevel.structureFeatureManager().getStructureAt(blockpos, true, this.feature).isValid())
                {
    ...
    public static LocationPredicate fromJson(@Nullable JsonElement pElement)
    {
        if (pElement != null && !pElement.isJsonNull())
        {
            JsonObject jsonobject = GsonHelper.convertToJsonObject(pElement, "location");

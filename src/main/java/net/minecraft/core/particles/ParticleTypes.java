...
public class ParticleTypes
{
    ...
    private static SimpleParticleType register(String pKey, boolean pDeserializer)
    {
        return Registry.register(Registry.PARTICLE_TYPE, pKey, new SimpleParticleType(pDeserializer));
    }

    private static <T extends ParticleOptions> ParticleType<T> register(String pKey, ParticleOptions.Deserializer<T> pDeserializer, final Function<ParticleType<T>, Codec<T>> p_123823_)
    {
        return Registry.register(Registry.PARTICLE_TYPE, pKey, new ParticleType<T>(false, pDeserializer)
        {

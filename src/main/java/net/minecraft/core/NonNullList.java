...
public class NonNullList<E> extends AbstractList<E>
{
    ...
    public static <E> NonNullList<E> withSize(int pSize, E pFill)
    {
        Validate.notNull(pFill);
        Object[] aobject = new Object[pSize];
        Arrays.fill(aobject, pFill);
        return new NonNullList<>(Arrays.asList((E[])aobject), pFill);
    }

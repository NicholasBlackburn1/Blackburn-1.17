...
public final class TextureSlot
{
    ...
    private static TextureSlot create(String pName)
    {
        return new TextureSlot(pName, (TextureSlot)null);
    }

    private static TextureSlot create(String pName, TextureSlot p_125902_)
    {
        return new TextureSlot(pName, p_125902_);
    }

...
public class ShapedRecipeBuilder implements RecipeBuilder
{
    ...
    public static ShapedRecipeBuilder shaped(ItemLike pResult, int p_126120_)
    {
        return new ShapedRecipeBuilder(pResult, p_126120_);
    }
    ...
    {
        return this.define(pSymbol, Ingredient.m_43929_(pTag));
    }

...
public class ShapelessRecipeBuilder implements RecipeBuilder
{
    ...
    public static ShapelessRecipeBuilder shapeless(ItemLike pResult, int p_126193_)
    {
        return new ShapelessRecipeBuilder(pResult, p_126193_);
    }
    ...
    public ShapelessRecipeBuilder requires(ItemLike pTag, int p_126213_)
    {
        for (int i = 0; i < p_126213_; ++i)
        {
            this.requires(Ingredient.m_43929_(pTag));
        }
    ...
    public ShapelessRecipeBuilder requires(Ingredient pTag, int p_126188_)
    {
        for (int i = 0; i < p_126188_; ++i)
        {
            this.ingredients.add(pTag);
        }

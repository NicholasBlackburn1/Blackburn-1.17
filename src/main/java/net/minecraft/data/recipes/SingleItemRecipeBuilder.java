...
public class SingleItemRecipeBuilder implements RecipeBuilder
{
    ...
    public static SingleItemRecipeBuilder stonecutting(Ingredient pIngredient, ItemLike pResult, int p_126319_)
    {
        return new SingleItemRecipeBuilder(RecipeSerializer.STONECUTTER, pIngredient, pResult, p_126319_);
    }

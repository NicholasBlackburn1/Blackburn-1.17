...
public class HusbandryAdvancements implements Consumer<Consumer<Advancement>>
{
    ...
    public void accept(Consumer<Advancement> p_123998_)
    {
        ...
        Advancement advancement6 = Advancement.Builder.advancement().parent(advancement5).requirements(RequirementsStrategy.OR).addCriterion(Registry.ITEM.getKey(Items.AXOLOTL_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().m_151445_(Items.AXOLOTL_BUCKET).build())).display(Items.AXOLOTL_BUCKET, new TranslatableComponent("advancements.husbandry.axolotl_in_a_bucket.title"), new TranslatableComponent("advancements.husbandry.axolotl_in_a_bucket.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).save(p_123998_, "husbandry/axolotl_in_a_bucket");
    ...
    private Advancement.Builder addBreedable(Advancement.Builder pBuilder)
    {
        ...
        pBuilder.addCriterion(EntityType.getKey(EntityType.TURTLE).toString(), BredAnimalsTrigger.TriggerInstance.bredAnimals(EntityPredicate.Builder.entity().of(EntityType.TURTLE).build(), EntityPredicate.Builder.entity().of(EntityType.TURTLE).build(), EntityPredicate.ANY));
        return pBuilder;
    }
    ...
    private Advancement.Builder addFishBuckets(Advancement.Builder pBuilder)
    {
        ...
        {
            pBuilder.addCriterion(Registry.ITEM.getKey(item).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().m_151445_(item).build()));
        }
    ...
    private Advancement.Builder addFish(Advancement.Builder pBuilder)
    {
        for (Item item : FISH)
        {
            pBuilder.addCriterion(Registry.ITEM.getKey(item).getPath(), FishingRodHookedTrigger.TriggerInstance.fishedItem(ItemPredicate.ANY, EntityPredicate.ANY, ItemPredicate.Builder.item().m_151445_(item).build()));
        }
    ...
    private Advancement.Builder addCatVariants(Advancement.Builder pBuilder)
    {
        ...
        {
            pBuilder.addCriterion(p_124004_.getPath(), TameAnimalTrigger.TriggerInstance.tamedAnimal(EntityPredicate.Builder.entity().of(p_124004_).build()));
        });
        return pBuilder;
    }
}

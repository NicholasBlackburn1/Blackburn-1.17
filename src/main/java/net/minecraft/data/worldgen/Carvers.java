...
public class Carvers
{
    ...
    public static final ConfiguredWorldCarver<CaveCarverConfiguration> NETHER_CAVE = register("nether_cave", WorldCarver.NETHER_CAVE.configured(new CaveCarverConfiguration(0.2F, UniformHeight.of(VerticalAnchor.absolute(0), VerticalAnchor.belowTop(1)), ConstantFloat.of(0.5F), VerticalAnchor.aboveBottom(10), false, ConstantFloat.of(1.0F), ConstantFloat.of(1.0F), ConstantFloat.of(-0.7F))));
    public static final ConfiguredWorldCarver<CanyonCarverConfiguration> PROTOTYPE_CREVICE = register("prototype_crevice", WorldCarver.CANYON.configured(new CanyonCarverConfiguration(0.00125F, UniformHeight.of(VerticalAnchor.absolute(40), VerticalAnchor.absolute(80)), UniformFloat.of(6.0F, 8.0F), VerticalAnchor.aboveBottom(8), false, CarverDebugSettings.of(false, Blocks.OAK_BUTTON.defaultBlockState()), UniformFloat.of(-0.125F, 0.125F), new CanyonCarverConfiguration.CanyonShapeConfiguration(UniformFloat.of(0.5F, 1.0F), UniformFloat.of(0.0F, 1.0F), 6, UniformFloat.of(0.25F, 1.0F), 0.0F, 5.0F))));

    private static <WC extends CarverConfiguration> ConfiguredWorldCarver<WC> register(String pName, ConfiguredWorldCarver<WC> pCarver)
    {
        return BuiltinRegistries.register(BuiltinRegistries.CONFIGURED_CARVER, pName, pCarver);
    }
}

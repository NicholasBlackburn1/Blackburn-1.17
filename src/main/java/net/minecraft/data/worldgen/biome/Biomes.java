...
public abstract class Biomes
{
    ...
    private static Biome register(int pId, ResourceKey<Biome> pKey, Biome pBiome)
    {
        TO_NAME.put(pId, pKey);
        return BuiltinRegistries.registerMapping(BuiltinRegistries.BIOME, pId, pKey, pBiome);
    }

    public static ResourceKey<Biome> byId(int pId)
    {
        return TO_NAME.get(pId);
    }

...
public class SurfaceBuilders
{
    ...
    private static <SC extends SurfaceBuilderConfiguration> ConfiguredSurfaceBuilder<SC> register(String pName, ConfiguredSurfaceBuilder<SC> pConfiguredSurfaceBuilder)
    {
        return BuiltinRegistries.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, pName, pConfiguredSurfaceBuilder);
    }
}

...
public class OcelotModel<T extends Entity> extends AgeableListModel<T>
{
    ...
    public OcelotModel(ModelPart p_170767_)
    {
        ...
        this.head = p_170767_.getChilds("head");
        this.body = p_170767_.getChilds("body");
        this.tail1 = p_170767_.getChilds("tail1");
        this.tail2 = p_170767_.getChilds("tail2");
        this.leftHindLeg = p_170767_.getChilds("left_hind_leg");
        this.rightHindLeg = p_170767_.getChilds("right_hind_leg");
        this.leftFrontLeg = p_170767_.getChilds("left_front_leg");
        this.rightFrontLeg = p_170767_.getChilds("right_front_leg");
    }

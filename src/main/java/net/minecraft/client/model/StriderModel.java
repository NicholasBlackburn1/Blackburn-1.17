...
public class StriderModel<T extends Strider> extends HierarchicalModel<T>
{
    ...
    {
        this.root = p_171011_;
        this.rightLeg = p_171011_.getChilds("right_leg");
        this.leftLeg = p_171011_.getChilds("left_leg");
        this.body = p_171011_.getChilds("body");
        this.rightBottomBristle = this.body.getChilds("right_bottom_bristle");
        this.rightMiddleBristle = this.body.getChilds("right_middle_bristle");
        this.rightTopBristle = this.body.getChilds("right_top_bristle");
        this.leftTopBristle = this.body.getChilds("left_top_bristle");
        this.leftMiddleBristle = this.body.getChilds("left_middle_bristle");
        this.leftBottomBristle = this.body.getChilds("left_bottom_bristle");
    }

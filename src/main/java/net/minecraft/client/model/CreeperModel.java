...
public class CreeperModel<T extends Entity> extends HierarchicalModel<T>
{
    ...
    {
        this.root = p_170524_;
        this.head = p_170524_.getChilds("head");
        this.leftHindLeg = p_170524_.getChilds("right_hind_leg");
        this.rightHindLeg = p_170524_.getChilds("left_hind_leg");
        this.leftFrontLeg = p_170524_.getChilds("right_front_leg");
        this.rightFrontLeg = p_170524_.getChilds("left_front_leg");
    }

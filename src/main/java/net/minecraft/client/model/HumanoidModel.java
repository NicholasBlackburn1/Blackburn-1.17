...
public class HumanoidModel<T extends LivingEntity> extends AgeableListModel<T> implements ArmedModel, HeadedModel
{
    ...
    public HumanoidModel(ModelPart p_170679_, Function<ResourceLocation, RenderType> p_170680_)
    {
        ...
        this.head = p_170679_.getChilds("head");
        this.hat = p_170679_.getChilds("hat");
        this.body = p_170679_.getChilds("body");
        this.rightArm = p_170679_.getChilds("right_arm");
        this.leftArm = p_170679_.getChilds("left_arm");
        this.rightLeg = p_170679_.getChilds("right_leg");
        this.leftLeg = p_170679_.getChilds("left_leg");
    }

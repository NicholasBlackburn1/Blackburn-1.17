...
public class PhantomModel<T extends Phantom> extends HierarchicalModel<T>
{
    ...
    {
        this.root = p_170788_;
        ModelPart modelpart = p_170788_.getChilds("body");
        this.tailBase = modelpart.getChilds("tail_base");
        this.tailTip = this.tailBase.getChilds("tail_tip");
        this.leftWingBase = modelpart.getChilds("left_wing_base");
        this.leftWingTip = this.leftWingBase.getChilds("left_wing_tip");
        this.rightWingBase = modelpart.getChilds("right_wing_base");
        this.rightWingTip = this.rightWingBase.getChilds("right_wing_tip");
    }

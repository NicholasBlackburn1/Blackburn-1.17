...
public class FoxModel<T extends Fox> extends AgeableListModel<T>
{
    ...
    public FoxModel(ModelPart p_170566_)
    {
        ...
        this.head = p_170566_.getChilds("head");
        this.body = p_170566_.getChilds("body");
        this.rightHindLeg = p_170566_.getChilds("right_hind_leg");
        this.leftHindLeg = p_170566_.getChilds("left_hind_leg");
        this.rightFrontLeg = p_170566_.getChilds("right_front_leg");
        this.leftFrontLeg = p_170566_.getChilds("left_front_leg");

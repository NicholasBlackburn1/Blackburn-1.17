...
public class ChickenModel<T extends Entity> extends AgeableListModel<T>
{
    ...
    {
        this.head = p_170490_.getChilds("head");
        this.beak = p_170490_.getChilds("beak");
        this.redThing = p_170490_.getChilds("red_thing");
        this.body = p_170490_.getChilds("body");
        this.rightLeg = p_170490_.getChilds("right_leg");
        this.leftLeg = p_170490_.getChilds("left_leg");
        this.rightWing = p_170490_.getChilds("right_wing");
        this.leftWing = p_170490_.getChilds("left_wing");
    }

...
public class WolfModel<T extends Wolf> extends ColorableAgeableListModel<T>
{
    ...
    {
        this.head = p_171087_.getChilds("head");
        this.realHead = this.head.getChilds("real_head");
        this.body = p_171087_.getChilds("body");
        this.upperBody = p_171087_.getChilds("upper_body");
        this.rightHindLeg = p_171087_.getChilds("right_hind_leg");
        this.leftHindLeg = p_171087_.getChilds("left_hind_leg");
        this.rightFrontLeg = p_171087_.getChilds("right_front_leg");
        this.leftFrontLeg = p_171087_.getChilds("left_front_leg");
        this.tail = p_171087_.getChilds("tail");
        this.realTail = this.tail.getChilds("real_tail");
    }

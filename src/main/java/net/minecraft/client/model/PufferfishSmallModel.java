...
public class PufferfishSmallModel<T extends Entity> extends HierarchicalModel<T>
{
    ...
    {
        this.root = p_170849_;
        this.leftFin = p_170849_.getChilds("left_fin");
        this.rightFin = p_170849_.getChilds("right_fin");
    }
    ...
    {
        this.rightFin.zRot = -0.2F + 0.4F * Mth.sin(pAgeInTicks * 0.2F);
        this.leftFin.zRot = 0.2F - 0.4F * Mth.sin(pAgeInTicks * 0.2F);
    }
}

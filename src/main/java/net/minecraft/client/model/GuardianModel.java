...
public class GuardianModel extends HierarchicalModel<Guardian>
{
    ...
    public GuardianModel(ModelPart p_170600_)
    {
        ...
        this.head = p_170600_.getChilds("head");

        for (int i = 0; i < this.spikeParts.length; ++i)
        {
            this.spikeParts[i] = this.head.getChilds(createSpikeName(i));
        }

        this.eye = this.head.getChilds("eye");
        this.tailParts = new ModelPart[3];
        this.tailParts[0] = this.head.getChilds("tail0");
        this.tailParts[1] = this.tailParts[0].getChilds("tail1");
        this.tailParts[2] = this.tailParts[1].getChilds("tail2");
    }

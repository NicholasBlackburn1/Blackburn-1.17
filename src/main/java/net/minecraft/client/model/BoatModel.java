...
public class BoatModel extends ListModel<Boat>
{
    ...
    {
        this.leftPaddle = p_170462_.getChilds("left_paddle");
        this.rightPaddle = p_170462_.getChilds("right_paddle");
        this.waterPatch = p_170462_.getChilds("water_patch");
        this.parts = ImmutableList.of(p_170462_.getChilds("bottom"), p_170462_.getChilds("back"), p_170462_.getChilds("front"), p_170462_.getChilds("right"), p_170462_.getChilds("left"), this.leftPaddle, this.rightPaddle);
    }

...
public class SnowGolemModel<T extends Entity> extends HierarchicalModel<T>
{
    ...
    {
        this.root = p_170965_;
        this.head = p_170965_.getChilds("head");
        this.leftArm = p_170965_.getChilds("left_arm");
        this.rightArm = p_170965_.getChilds("right_arm");
        this.upperBody = p_170965_.getChilds("upper_body");
    }

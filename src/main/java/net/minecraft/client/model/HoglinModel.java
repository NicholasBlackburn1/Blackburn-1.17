...
public class HoglinModel<T extends Mob & HoglinBase> extends AgeableListModel<T>
{
    ...
    public HoglinModel(ModelPart p_170640_)
    {
        ...
        this.body = p_170640_.getChilds("body");
        this.mane = this.body.getChilds("mane");
        this.head = p_170640_.getChilds("head");
        this.rightEar = this.head.getChilds("right_ear");
        this.leftEar = this.head.getChilds("left_ear");
        this.rightFrontLeg = p_170640_.getChilds("right_front_leg");
        this.leftFrontLeg = p_170640_.getChilds("left_front_leg");
        this.rightHindLeg = p_170640_.getChilds("right_hind_leg");
        this.leftHindLeg = p_170640_.getChilds("left_hind_leg");
    }
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        partdefinition2.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(1, 1).addBox(-6.0F, -1.0F, -2.0F, 6.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(-6.0F, -2.0F, -3.0F, 0.0F, 0.0F, -((float)Math.PI * 2F / 9F)));
        partdefinition2.addOrReplaceChild("left_ear", CubeListBuilder.create().texOffs(1, 6).addBox(0.0F, -1.0F, -2.0F, 6.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(6.0F, -2.0F, -3.0F, 0.0F, 0.0F, ((float)Math.PI * 2F / 9F)));
    ...
    {
        this.rightEar.zRot = -((float)Math.PI * 2F / 9F) - pLimbSwingAmount * Mth.sin(pLimbSwing);
        this.leftEar.zRot = ((float)Math.PI * 2F / 9F) + pLimbSwingAmount * Mth.sin(pLimbSwing);

...
public class RabbitModel<T extends Rabbit> extends EntityModel<T>
{
    ...
    {
        this.leftRearFoot = p_170881_.getChilds("left_hind_foot");
        this.rightRearFoot = p_170881_.getChilds("right_hind_foot");
        this.leftHaunch = p_170881_.getChilds("left_haunch");
        this.rightHaunch = p_170881_.getChilds("right_haunch");
        this.body = p_170881_.getChilds("body");
        this.leftFrontLeg = p_170881_.getChilds("left_front_leg");
        this.rightFrontLeg = p_170881_.getChilds("right_front_leg");
        this.head = p_170881_.getChilds("head");
        this.rightEar = p_170881_.getChilds("right_ear");
        this.leftEar = p_170881_.getChilds("left_ear");
        this.tail = p_170881_.getChilds("tail");
        this.nose = p_170881_.getChilds("nose");
    }
    ...
    public void renderToBuffer(PoseStack pMatrixStack, VertexConsumer pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha)
    {
        if (this.young)
        {
            ...
            {
                p_103597_.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
            });
            ...
            {
                p_103587_.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
            });
            pMatrixStack.popPose();
        }
        else
        {
            ...
            {
                p_103572_.render(pMatrixStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
            });
            pMatrixStack.popPose();
        }
    }

...
public class BeeModel<T extends Bee> extends AgeableListModel<T>
{
    ...
    public BeeModel(ModelPart p_170439_)
    {
        ...
        this.bone = p_170439_.getChilds("bone");
        ModelPart modelpart = this.bone.getChilds("body");
        this.stinger = modelpart.getChilds("stinger");
        this.leftAntenna = modelpart.getChilds("left_antenna");
        this.rightAntenna = modelpart.getChilds("right_antenna");
        this.rightWing = this.bone.getChilds("right_wing");
        this.leftWing = this.bone.getChilds("left_wing");
        this.frontLeg = this.bone.getChilds("front_legs");
        this.midLeg = this.bone.getChilds("middle_legs");
        this.backLeg = this.bone.getChilds("back_legs");
    }

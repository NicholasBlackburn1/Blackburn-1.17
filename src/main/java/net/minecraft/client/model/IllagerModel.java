...
public class IllagerModel<T extends AbstractIllager> extends HierarchicalModel<T> implements ArmedModel, HeadedModel
{
    ...
    {
        this.root = p_170688_;
        this.head = p_170688_.getChilds("head");
        this.hat = this.head.getChilds("hat");
        this.hat.visible = false;
        this.arms = p_170688_.getChilds("arms");
        this.leftLeg = p_170688_.getChilds("left_leg");
        this.rightLeg = p_170688_.getChilds("right_leg");
        this.leftArm = p_170688_.getChilds("left_arm");
        this.rightArm = p_170688_.getChilds("right_arm");
    }

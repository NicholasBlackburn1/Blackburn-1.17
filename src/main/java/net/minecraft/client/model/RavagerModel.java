...
public class RavagerModel extends HierarchicalModel<Ravager>
{
    ...
    {
        this.root = p_170889_;
        this.neck = p_170889_.getChilds("neck");
        this.head = this.neck.getChilds("head");
        this.mouth = this.head.getChilds("mouth");
        this.rightHindLeg = p_170889_.getChilds("right_hind_leg");
        this.leftHindLeg = p_170889_.getChilds("left_hind_leg");
        this.rightFrontLeg = p_170889_.getChilds("right_front_leg");
        this.leftFrontLeg = p_170889_.getChilds("left_front_leg");
    }
    ...
    public void prepareMobModel(Ravager pEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick)
    {
        ...
        else
        {
            ...
            this.neck.z = 5.5F;
            boolean flag = i > 0;
            this.neck.xRot = flag ? ((float)Math.PI * 7F / 100F) : 0.0F;

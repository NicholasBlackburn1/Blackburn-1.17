...
public class SpiderModel<T extends Entity> extends HierarchicalModel<T>
{
    ...
    {
        this.root = p_170984_;
        this.head = p_170984_.getChilds("head");
        this.rightHindLeg = p_170984_.getChilds("right_hind_leg");
        this.leftHindLeg = p_170984_.getChilds("left_hind_leg");
        this.rightMiddleHindLeg = p_170984_.getChilds("right_middle_hind_leg");
        this.leftMiddleHindLeg = p_170984_.getChilds("left_middle_hind_leg");
        this.rightMiddleFrontLeg = p_170984_.getChilds("right_middle_front_leg");
        this.leftMiddleFrontLeg = p_170984_.getChilds("left_middle_front_leg");
        this.rightFrontLeg = p_170984_.getChilds("right_front_leg");
        this.leftFrontLeg = p_170984_.getChilds("left_front_leg");
    }

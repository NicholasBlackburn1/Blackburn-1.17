...
{
    public final ModelPart rightEar = this.head.getChilds("right_ear");
    private final ModelPart leftEar = this.head.getChilds("left_ear");
    ...
    public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch)
    {
        ...
        if (pEntity instanceof AbstractPiglin)
        {
            AbstractPiglin abstractpiglin = (AbstractPiglin)pEntity;

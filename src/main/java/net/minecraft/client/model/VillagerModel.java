...
public class VillagerModel<T extends Entity> extends HierarchicalModel<T> implements HeadedModel, VillagerHeadModel
{
    ...
    {
        this.root = p_171051_;
        this.head = p_171051_.getChilds("head");
        this.hat = this.head.getChilds("hat");
        this.hatRim = this.hat.getChilds("hat_rim");
        this.nose = this.head.getChilds("nose");
        this.rightLeg = p_171051_.getChilds("right_leg");
        this.leftLeg = p_171051_.getChilds("left_leg");
    }

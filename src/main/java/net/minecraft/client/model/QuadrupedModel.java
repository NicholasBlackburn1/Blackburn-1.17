...
public class QuadrupedModel<T extends Entity> extends AgeableListModel<T>
{
    ...
    protected QuadrupedModel(ModelPart p_170857_, boolean p_170858_, float p_170859_, float p_170860_, float p_170861_, float p_170862_, int p_170863_)
    {
        ...
        this.head = p_170857_.getChilds("head");
        this.body = p_170857_.getChilds("body");
        this.rightHindLeg = p_170857_.getChilds("right_hind_leg");
        this.leftHindLeg = p_170857_.getChilds("left_hind_leg");
        this.rightFrontLeg = p_170857_.getChilds("right_front_leg");
        this.leftFrontLeg = p_170857_.getChilds("left_front_leg");
    }

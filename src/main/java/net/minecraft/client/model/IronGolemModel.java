...
public class IronGolemModel<T extends IronGolem> extends HierarchicalModel<T>
{
    ...
    {
        this.root = p_170697_;
        this.head = p_170697_.getChilds("head");
        this.rightArm = p_170697_.getChilds("right_arm");
        this.leftArm = p_170697_.getChilds("left_arm");
        this.rightLeg = p_170697_.getChilds("right_leg");
        this.leftLeg = p_170697_.getChilds("left_leg");
    }

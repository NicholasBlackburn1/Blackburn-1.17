...
public class HorseModel<T extends AbstractHorse> extends AgeableListModel<T>
{
    ...
    public HorseModel(ModelPart p_170668_)
    {
        ...
        this.body = p_170668_.getChilds("body");
        this.headParts = p_170668_.getChilds("head_parts");
        this.rightHindLeg = p_170668_.getChilds("right_hind_leg");
        this.leftHindLeg = p_170668_.getChilds("left_hind_leg");
        this.rightFrontLeg = p_170668_.getChilds("right_front_leg");
        this.leftFrontLeg = p_170668_.getChilds("left_front_leg");
        this.rightHindBabyLeg = p_170668_.getChilds("right_hind_baby_leg");
        this.leftHindBabyLeg = p_170668_.getChilds("left_hind_baby_leg");
        this.rightFrontBabyLeg = p_170668_.getChilds("right_front_baby_leg");
        this.leftFrontBabyLeg = p_170668_.getChilds("left_front_baby_leg");
        this.tail = this.body.getChilds("tail");
        ModelPart modelpart = this.body.getChilds("saddle");
        ModelPart modelpart1 = this.headParts.getChilds("left_saddle_mouth");
        ModelPart modelpart2 = this.headParts.getChilds("right_saddle_mouth");
        ModelPart modelpart3 = this.headParts.getChilds("left_saddle_line");
        ModelPart modelpart4 = this.headParts.getChilds("right_saddle_line");
        ModelPart modelpart5 = this.headParts.getChilds("head_saddle");
        ModelPart modelpart6 = this.headParts.getChilds("mouth_saddle_wrap");
    ...
    public void prepareMobModel(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pPartialTick)
    {
        ...
        float f = Mth.rotlerp(pEntity.yBodyRotO, pEntity.yBodyRot, pPartialTick);
        float f1 = Mth.rotlerp(pEntity.yHeadRotO, pEntity.yHeadRot, pPartialTick);
        ...
        {
            f4 += Mth.cos(pLimbSwing * 0.4F) * 0.15F * pLimbSwingAmount;
        }
        ...
        this.tail.xRot = ((float)Math.PI / 6F) + pLimbSwingAmount * 0.75F;

...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon>
{
    ...
    public static class DragonModel extends EntityModel<EnderDragon>
    {
        ...
        {
            this.head = p_173976_.getChilds("head");
            this.jaw = this.head.getChilds("jaw");
            this.neck = p_173976_.getChilds("neck");
            this.body = p_173976_.getChilds("body");
            this.leftWing = p_173976_.getChilds("left_wing");
            this.leftWingTip = this.leftWing.getChilds("left_wing_tip");
            this.leftFrontLeg = p_173976_.getChilds("left_front_leg");
            this.leftFrontLegTip = this.leftFrontLeg.getChilds("left_front_leg_tip");
            this.leftFrontFoot = this.leftFrontLegTip.getChilds("left_front_foot");
            this.leftRearLeg = p_173976_.getChilds("left_hind_leg");
            this.leftRearLegTip = this.leftRearLeg.getChilds("left_hind_leg_tip");
            this.leftRearFoot = this.leftRearLegTip.getChilds("left_hind_foot");
            this.rightWing = p_173976_.getChilds("right_wing");
            this.rightWingTip = this.rightWing.getChilds("right_wing_tip");
            this.rightFrontLeg = p_173976_.getChilds("right_front_leg");
            this.rightFrontLegTip = this.rightFrontLeg.getChilds("right_front_leg_tip");
            this.rightFrontFoot = this.rightFrontLegTip.getChilds("right_front_foot");
            this.rightRearLeg = p_173976_.getChilds("right_hind_leg");
            this.rightRearLegTip = this.rightRearLeg.getChilds("right_hind_leg_tip");
            this.rightRearFoot = this.rightRearLegTip.getChilds("right_hind_foot");
        }
        ...
        public void renderToBuffer(PoseStack pMatrixStack, VertexConsumer pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha)
        {
            ...
            for (int i = 0; i < 5; ++i)
            {
                ...
                this.neck.xRot = f9 + this.entity.m_31108_(i, adouble, adouble1) * ((float)Math.PI / 180F) * 1.5F * 5.0F;
            ...
            this.head.xRot = Mth.rotWrap((double)this.entity.m_31108_(6, adouble, adouble2)) * ((float)Math.PI / 180F) * 1.5F * 5.0F;

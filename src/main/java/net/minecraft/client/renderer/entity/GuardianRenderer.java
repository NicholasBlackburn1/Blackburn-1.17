...
public class GuardianRenderer extends MobRenderer<Guardian, GuardianModel>
{
    ...
    public boolean shouldRender(Guardian pLivingEntity, Frustum pCamera, double pCamX, double p_114839_, double pCamY)
    {
        if (super.shouldRender(pLivingEntity, pCamera, pCamX, p_114839_, pCamY))
        {
            return true;
        }
        else

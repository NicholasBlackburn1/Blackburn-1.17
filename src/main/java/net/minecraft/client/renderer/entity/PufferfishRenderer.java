...
public class PufferfishRenderer extends MobRenderer<Pufferfish, EntityModel<Pufferfish>>
{
    ...
    public void render(Pufferfish pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight)
    {
    ...
    protected void setupRotations(Pufferfish pEntityLiving, PoseStack pMatrixStack, float pAgeInTicks, float pRotationYaw, float pPartialTicks)
    {

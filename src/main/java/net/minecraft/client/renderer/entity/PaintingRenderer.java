    ...
    private void renderPainting(PoseStack p_115559_, VertexConsumer p_115560_, Painting p_115561_, int p_115562_, int p_115563_, TextureAtlasSprite p_115564_, TextureAtlasSprite p_115565_)
    {
        ...
        for (int k = 0; k < i; ++k)
        {
            for (int l = 0; l < j; ++l)
            {
                ...
                this.vertex(matrix4f, matrix3f, p_115560_, f15, f17, f3, f5, 0.5F, 0, 0, 1, l1);
                this.vertex(matrix4f, matrix3f, p_115560_, f16, f17, f4, f5, 0.5F, 0, 0, 1, l1);
                this.vertex(matrix4f, matrix3f, p_115560_, f16, f18, f4, f6, 0.5F, 0, 0, 1, l1);
                this.vertex(matrix4f, matrix3f, p_115560_, f15, f18, f3, f6, 0.5F, 0, 0, 1, l1);

...
public class EffectInstance implements Effect, AutoCloseable
{
    ...
    public EffectInstance(ResourceManager p_108941_, String p_108942_) throws IOException
    {
        ...
        {
            ResourceLocation resourcelocation1 = ResourceLocation.tryParse(p_108942_);
        ...
        try
        {
            ...
            this.vertexProgram = getOrCreate(p_108941_, Program.Type.VERTEX, s1);
        ...
        catch (Exception exception31)
        {
            ...
            chainedjsonexception.setFilenameAndFlush(resourcelocation.getPath() + s);
    ...
    public static EffectProgram getOrCreate(ResourceManager p_172567_, Program.Type p_172568_, String p_172569_) throws IOException
    {
        ...
        else
        {
            ...
            if (program == null)
            {
                ...
                if (Reflector.MinecraftForgeClient.exists())
                {
                    ResourceLocation resourcelocation1 = ResourceLocation.tryParse(p_172569_);
                    resourcelocation = new ResourceLocation(resourcelocation1.getNamespace(), "shaders/program/" + resourcelocation1.getPath() + p_172568_.getExtension());
                }

...
public class ItemModelGenerator
{
    ...
    public BlockModel generateBlockModel(Function<Material, TextureAtlasSprite> pTextureGetter, BlockModel pBlockModel)
    {
        ...
        for (int i = 0; i < LAYERS.size(); ++i)
        {
            ...
            Material material = pBlockModel.getMaterial(s);
            map.put(s, Either.left(material));
            TextureAtlasSprite textureatlassprite = pTextureGetter.apply(material);

...
public class BellRenderer implements BlockEntityRenderer<BellBlockEntity>
{
    ...
    public BellRenderer(BlockEntityRendererProvider.Context p_173554_)
    {
        ...
        this.bellBody = modelpart.getChilds("bell_body");
    }
    ...
    public void render(BellBlockEntity pBlockEntity, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pCombinedLight, int pCombinedOverlay)
    {
        ...
        VertexConsumer vertexconsumer = BELL_RESOURCE_LOCATION.buffer(pBuffer, RenderType::entitySolid);
        this.bellBody.render(pMatrixStack, vertexconsumer, pCombinedLight, pCombinedOverlay);
    }
}

...
public class SolidFaceRenderer implements DebugRenderer.SimpleDebugRenderer
{
    ...
    public void render(PoseStack pMatrixStack, MultiBufferSource pBuffer, double pCamX, double p_113673_, double pCamY)
    {
        ...
        BlockPos blockpos = new BlockPos(pCamX, p_113673_, pCamY);
        ...
        for (BlockPos blockpos1 : BlockPos.betweenClosed(blockpos.offset(-6, -6, -6), blockpos.offset(6, 6, 6)))
        {
            ...
            if (!blockstate.is(Blocks.AIR))
            {
                ...
                {
                    AABB aabb1 = aabb.move(blockpos1).inflate(0.002D).move(-pCamX, -p_113673_, -pCamY);

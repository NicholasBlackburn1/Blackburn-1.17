...
public class ChunkDebugRenderer implements DebugRenderer.SimpleDebugRenderer
{
    ...
    public void render(PoseStack pMatrixStack, MultiBufferSource pBuffer, double pCamX, double p_113373_, double pCamY)
    {
        ...
        if (d0 - this.lastUpdateTime > 3.0E9D)
        {
            ...
            {
                this.data = new ChunkDebugRenderer.ChunkData(integratedserver, pCamX, pCamY);
            }
            else
            {
                this.data = null;

...
public class LightDebugRenderer implements DebugRenderer.SimpleDebugRenderer
{
    ...
    public void render(PoseStack pMatrixStack, MultiBufferSource pBuffer, double pCamX, double p_113590_, double pCamY)
    {
        Level level = this.minecraft.level;
        RenderSystem.enableBlend();
        RenderSystem.defaultBlendFunc();
        RenderSystem.disableTexture();
        BlockPos blockpos = new BlockPos(pCamX, p_113590_, pCamY);

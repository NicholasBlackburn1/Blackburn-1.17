...
public class StructureRenderer implements DebugRenderer.SimpleDebugRenderer
{
    ...
    public void render(PoseStack pMatrixStack, MultiBufferSource pBuffer, double pCamX, double p_113691_, double pCamY)
    {
        ...
        if (this.postMainBoxes.containsKey(dimensiontype))
        {
            for (BoundingBox boundingbox : this.postMainBoxes.get(dimensiontype).values())
            {
                ...
                {
                    LevelRenderer.renderLineBox(pMatrixStack, vertexconsumer, (double)boundingbox.minX() - pCamX, (double)boundingbox.minY() - p_113691_, (double)boundingbox.minZ() - pCamY, (double)(boundingbox.maxX() + 1) - pCamX, (double)(boundingbox.maxY() + 1) - p_113691_, (double)(boundingbox.maxZ() + 1) - pCamY, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
                }
            }
        }
        ...
        if (this.postPiecesBoxes.containsKey(dimensiontype))
        {
            for (Entry<String, BoundingBox> entry : this.postPiecesBoxes.get(dimensiontype).entrySet())
            {
                ...
                if (blockpos.closerThan(boundingbox1.getCenter(), 500.0D))
                {
                    if (obool)
                    {
                        LevelRenderer.renderLineBox(pMatrixStack, vertexconsumer, (double)boundingbox1.minX() - pCamX, (double)boundingbox1.minY() - p_113691_, (double)boundingbox1.minZ() - pCamY, (double)(boundingbox1.maxX() + 1) - pCamX, (double)(boundingbox1.maxY() + 1) - p_113691_, (double)(boundingbox1.maxZ() + 1) - pCamY, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
                    }
                    else
                    {
                        LevelRenderer.renderLineBox(pMatrixStack, vertexconsumer, (double)boundingbox1.minX() - pCamX, (double)boundingbox1.minY() - p_113691_, (double)boundingbox1.minZ() - pCamY, (double)(boundingbox1.maxX() + 1) - pCamX, (double)(boundingbox1.maxY() + 1) - p_113691_, (double)(boundingbox1.maxZ() + 1) - pCamY, 0.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F);
                    }
                }
            }
        }

...
public class ClientPackSource implements RepositorySource
{
    ...
    public CompletableFuture<?> downloadAndSelectResourcePack(String p_174814_, String p_174815_, boolean p_174816_)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                completablefuture = HttpUtil.downloadTo(file1, p_174814_, map, 104857600, progressscreen, minecraft.getProxy());
            }
    ...
    public CompletableFuture<Void> setServerPack(File pFile, PackSource p_118568_)
    {

...
public class MouseHandler
{
    ...
    private void onPress(long pHandle, int p_91532_, int pButton, int pAction)
    {
    ...
    private void onScroll(long pHandle, double p_91528_, double pXoffset)
    {
        if (pHandle == Minecraft.getInstance().getWindow().getWindow())
        {
            double d0 = (this.minecraft.options.discreteMouseScroll ? Math.signum(pXoffset) : pXoffset) * this.minecraft.options.mouseWheelSensitivity;
    ...
    private void onDrop(long pWindow, List<Path> p_91541_)
    {
        if (this.minecraft.screen != null)
        {
    ...
    {
        InputConstants.setupMouseCallbacks(pHandle, (p_91591_, p_91592_, p_91593_) ->
        {
    ...
    private void onMove(long pHandle, double p_91563_, double pXpos)
    {
        if (pHandle == Minecraft.getInstance().getWindow().getWindow())
        {
            ...
            if (screen != null && this.minecraft.getOverlay() == null)
            {
                ...
                double d1 = pXpos * (double)this.minecraft.getWindow().getGuiScaledHeight() / (double)this.minecraft.getWindow().getScreenHeight();
                Screen.wrapScreenError(() ->
                {
            ...
            if (this.isMouseGrabbed() && this.minecraft.isWindowActive())
            {
                ...
                this.accumulatedDY += pXpos - this.ypos;
            }

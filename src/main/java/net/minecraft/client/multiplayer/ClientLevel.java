...
public class ClientLevel extends Level {
   ...
   public void unload(LevelChunk p_104666_) {
      p_104666_.invalidateAllBlockEntities();
   ...
   public void onChunkLoaded(ChunkPos p_171650_) {
      this.tintCaches.forEach((p_171653_, p_171654_) -> {
         p_171654_.invalidateForChunk(p_171650_.x, p_171650_.z);
      });
   ...
   public void animateTick(int p_104785_, int p_104786_, int p_104787_) {
      ...
      for(int j = 0; j < 667; ++j) {
         this.doAnimateTick(p_104785_, p_104786_, p_104787_, 16, random, clientlevel$markerparticlestatus, blockpos$mutableblockpos);
         this.doAnimateTick(p_104785_, p_104786_, p_104787_, 32, random, clientlevel$markerparticlestatus, blockpos$mutableblockpos);
      }
   ...
   public int getBlockTint(BlockPos p_104700_, ColorResolver p_104701_) {
      ...
      return blocktintcache.getColor(p_104700_, () -> {
         return this.calculateBlockTint(p_104700_, p_104701_);
      });
   }

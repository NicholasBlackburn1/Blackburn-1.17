...
public class StringSplitter
{
    ...
    static class LineComponent implements FormattedText
    {
        ...
        public <T> Optional<T> visit(FormattedText.StyledContentConsumer<T> pAcceptor, Style p_92496_)
        {
            return pAcceptor.accept(this.style.applyTo(p_92496_), this.contents);
        }
    }

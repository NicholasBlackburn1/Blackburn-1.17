    ...
    public void render(PoseStack p_93705_)
    {
        if (!this.events.isEmpty())
        {
            ...
            for (LerpingBossEvent lerpingbossevent : this.events.values())
            {
                ...
                {
                    Object object = Reflector.ForgeHooksClient_bossBarRenderPre.call(p_93705_, this.minecraft.getWindow(), lerpingbossevent, k, j, 10 + 9);
                ...
                if (flag)
                {
                    ...
                    this.minecraft.font.drawShadow(p_93705_, component, (float)j1, (float)k1, l1);
                }

                j += l;
                Reflector.ForgeHooksClient_bossBarRenderPost.callVoid(p_93705_, this.minecraft.getWindow());

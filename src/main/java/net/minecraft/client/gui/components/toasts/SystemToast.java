...
public class SystemToast implements Toast
{
    ...
    {
        this(p_94832_, p_94833_, nullToEmpty(p_94834_), 160);
    }
    ...
    public void reset(Component pTitleComponent, @Nullable Component pSubtitleComponent)
    {
        this.title = pTitleComponent;
        this.messageLines = nullToEmpty(pSubtitleComponent);
        this.changed = true;
    }

...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
   ...
   public boolean mouseClicked(double p_97748_, double p_97749_, int p_97750_) {
      if (super.mouseClicked(p_97748_, p_97749_, p_97750_)) {
         ...
         boolean flag = this.minecraft.options.keyPickItem.matchesMouse(p_97750_);
            ...
            if (l != -1) {
               if (this.minecraft.options.touchscreen) {
                  ...
                  if (this.menu.getCarried().isEmpty()) {
                     if (this.minecraft.options.keyPickItem.matchesMouse(p_97750_)) {
                     ...
                     } else if (this.minecraft.options.keyPickItem.matchesMouse(p_97750_)) {

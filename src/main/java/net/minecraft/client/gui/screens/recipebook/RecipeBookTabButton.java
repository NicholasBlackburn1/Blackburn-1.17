...
public class RecipeBookTabButton extends StateSwitchingButton
{
    ...
    public void renderButton(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        if (this.animationTime > 0.0F)
        {
            ...
            pMatrixStack.translate((double)(this.x + 8), (double)(this.y + 12), 0.0D);
            pMatrixStack.scale(1.0F, f, 1.0F);
            pMatrixStack.translate((double)(-(this.x + 8)), (double)(-(this.y + 12)), 0.0D);
        }
        ...
        this.blit(pMatrixStack, k, this.y, i, j, this.width, this.height);
        ...
        if (this.animationTime > 0.0F)
        {
            ...
            this.animationTime -= pPartialTicks;
        }
    }

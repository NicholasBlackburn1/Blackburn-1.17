...
public class OptionsScreen extends Screen {
   ...
   protected void init() {
      ...
      if (this.minecraft.level != null) {
         this.difficultyButton = this.addRenderableWidget(CycleButton.builder(Difficulty::getDisplayName).withValues(Difficulty.values()).withInitialValue(this.minecraft.level.getDifficulty()).create(this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, new TranslatableComponent("options.difficulty"), (p_169330_, p_169331_) -> {

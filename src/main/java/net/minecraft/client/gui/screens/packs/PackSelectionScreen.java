...
public class PackSelectionScreen extends Screen
{
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        this.availablePackList.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        this.selectedPackList.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        drawCenteredString(pMatrixStack, this.font, this.title, this.width / 2, 8, 16777215);
        drawCenteredString(pMatrixStack, this.font, DRAG_AND_DROP, this.width / 2, 20, 16777215);

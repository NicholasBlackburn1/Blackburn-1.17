    ...
    class DetailsList extends ObjectSelectionList<CreateFlatWorldScreen.DetailsList.Entry>
    {
        ...
        class Entry extends ObjectSelectionList.Entry<CreateFlatWorldScreen.DetailsList.Entry>
        {
            public void render(PoseStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks)
            {
                ...
                CreateFlatWorldScreen.this.font.draw(pMatrixStack, itemstack.getHoverName(), (float)(pLeft + 18 + 5), (float)(pTop + 3), 16777215);
                Component component;
                ...
                CreateFlatWorldScreen.this.font.draw(pMatrixStack, component, (float)(pLeft + 2 + 213 - CreateFlatWorldScreen.this.font.width(component)), (float)(pTop + 3), 16777215);
            }

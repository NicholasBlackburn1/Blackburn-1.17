...
public class EditServerScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        this.addRenderableWidget(CycleButton.builder(ServerData.ServerPackStatus::getName).m_168961_(ServerData.ServerPackStatus.values()).withInitialValue(this.serverData.getResourcePackStatus()).create(this.width / 2 - 100, this.height / 4 + 72, 200, 20, new TranslatableComponent("addServer.resourcePack"), (p_169299_, p_169300_) ->
        {
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        drawString(pMatrixStack, this.font, NAME_LABEL, this.width / 2 - 100, 53, 10526880);
        drawString(pMatrixStack, this.font, IP_LABEL, this.width / 2 - 100, 94, 10526880);

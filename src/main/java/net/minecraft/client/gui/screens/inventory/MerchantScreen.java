...
public class MerchantScreen extends AbstractContainerScreen<MerchantMenu> {
   ...
   protected void renderBg(PoseStack p_99143_, float p_99144_, int p_99145_, int p_99146_) {
      ...
      int i = (this.width - this.imageWidth) / 2;
      int j = (this.height - this.imageHeight) / 2;
      blit(p_99143_, i, j, this.getBlitOffset(), 0.0F, 0.0F, this.imageWidth, this.imageHeight, 256, 512);
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         if (merchantoffer.isOutOfStock()) {
            RenderSystem.setShaderTexture(0, VILLAGER_LOCATION);
            RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
            blit(p_99143_, this.leftPos + 83 + 99, this.topPos + 35, this.getBlitOffset(), 311.0F, 0.0F, 28, 21, 256, 512);
         }
      }
   ...
   public boolean mouseScrolled(double p_99127_, double p_99128_, double p_99129_) {
      ...
      if (this.canScroll(i)) {
         int j = i - 7;
         this.scrollOff = (int)((double)this.scrollOff - p_99129_);

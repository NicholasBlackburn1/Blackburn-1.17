...
public class MouseSettingsScreen extends OptionsSubScreen
{
    ...
    protected void init()
    {
        ...
        {
            this.list.m_94476_(Stream.concat(Arrays.stream(OPTIONS), Stream.of(Option.RAW_MOUSE_INPUT)).toArray((p_96225_) ->
            {
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        drawCenteredString(pMatrixStack, this.font, this.title, this.width / 2, 5, 16777215);

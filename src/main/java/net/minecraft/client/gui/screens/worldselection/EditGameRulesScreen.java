...
public class EditGameRulesScreen extends Screen
{
    ...
    {
        this.tooltip = null;
        this.rules.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
    ...
    public class BooleanRuleEntry extends EditGameRulesScreen.GameRuleEntry
    {
        ...
        {
            this.renderLabel(pMatrixStack, pTop, pLeft);
            this.checkbox.x = pLeft + pWidth - 45;
            this.checkbox.y = pTop;
            this.checkbox.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        }
    }
    ...
    public class CategoryRuleEntry extends EditGameRulesScreen.RuleEntry
    {
        ...
        public void render(PoseStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks)
        {
            GuiComponent.drawCenteredString(pMatrixStack, EditGameRulesScreen.this.minecraft.font, this.label, pLeft + pWidth / 2, pTop + 5, 16777215);
        }
    ...
    public class RuleList extends ContainerObjectSelectionList<EditGameRulesScreen.RuleEntry>
    {
        public RuleList(final GameRules p_101203_)
        {
            ...
            {
                public void visitBoolean(GameRules.Key<GameRules.BooleanValue> pValue1, GameRules.Type<GameRules.BooleanValue> pValue2)
                {
                    this.addEntry(pValue1, (p_101228_, p_101229_, p_101230_, p_101231_) ->
                    {
                        return EditGameRulesScreen.this.new BooleanRuleEntry(p_101228_, p_101229_, p_101230_, p_101231_);
                    });
                }
                public void visitInteger(GameRules.Key<GameRules.IntegerValue> pValue1, GameRules.Type<GameRules.IntegerValue> pValue2)
                {
                    this.addEntry(pValue1, (p_101233_, p_101234_, p_101235_, p_101236_) ->
                    {
            ...
            {
                this.addEntry(EditGameRulesScreen.this.new CategoryRuleEntry((new TranslatableComponent(p_101210_.getKey().getDescriptionId())).m_130944_(new ChatFormatting[]{ChatFormatting.BOLD, ChatFormatting.YELLOW})));

...
public class LanguageSelectScreen extends OptionsSubScreen
{
    ...
    class LanguageSelectionList extends ObjectSelectionList<LanguageSelectScreen.LanguageSelectionList.Entry>
    {
        ...
        {
            LanguageSelectScreen.this.renderBackground(pMatrixStack);
        }
        ...
        public class Entry extends ObjectSelectionList.Entry<LanguageSelectScreen.LanguageSelectionList.Entry>
        {
            ...
            public void render(PoseStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks)
            {
                ...
                LanguageSelectScreen.this.font.drawShadow(pMatrixStack, s, (float)(LanguageSelectionList.this.width / 2 - LanguageSelectScreen.this.font.width(s) / 2), (float)(pTop + 1), 16777215, true);
            }

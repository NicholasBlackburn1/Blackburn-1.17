...
public class StructureBlockEditScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        this.mirrorButton = this.addRenderableWidget(CycleButton.builder(Mirror::symbol).m_168961_(Mirror.values()).displayOnlyValue().withInitialValue(this.initialMirror).create(this.width / 2 - 20, 185, 40, 20, new TextComponent("MIRROR"), (p_169843_, p_169844_) ->
        {
        ...
        this.nameEdit = new EditBox(this.font, this.width / 2 - 152, 40, 300, 20, new TranslatableComponent("structure_block.structure_name"))
        {
            ...
            {
                return !StructureBlockEditScreen.this.isValidCharacterForName(this.getValue(), pCodePoint, this.getCursorPosition()) ? false : super.charTyped(pCodePoint, pModifiers);
            }
        };
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        {
            drawString(pMatrixStack, this.font, NAME_LABEL, this.width / 2 - 153, 30, 10526880);
        ...
        {
            drawString(pMatrixStack, this.font, POSITION_LABEL, this.width / 2 - 153, 70, 10526880);
            this.posXEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
            this.posYEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
            this.posZEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
            drawString(pMatrixStack, this.font, INCLUDE_ENTITIES_LABEL, this.width / 2 + 154 - this.font.width(INCLUDE_ENTITIES_LABEL), 150, 10526880);
        }

        if (structuremode == StructureMode.SAVE)
        {
            drawString(pMatrixStack, this.font, SIZE_LABEL, this.width / 2 - 153, 110, 10526880);
            this.sizeXEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
            this.sizeYEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
            this.sizeZEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
            drawString(pMatrixStack, this.font, DETECT_SIZE_LABEL, this.width / 2 + 154 - this.font.width(DETECT_SIZE_LABEL), 110, 10526880);
            drawString(pMatrixStack, this.font, SHOW_AIR_LABEL, this.width / 2 + 154 - this.font.width(SHOW_AIR_LABEL), 70, 10526880);
        }

        if (structuremode == StructureMode.LOAD)
        {
            drawString(pMatrixStack, this.font, INTEGRITY_LABEL, this.width / 2 - 153, 110, 10526880);
            this.integrityEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
            this.seedEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
            drawString(pMatrixStack, this.font, SHOW_BOUNDING_BOX_LABEL, this.width / 2 + 154 - this.font.width(SHOW_BOUNDING_BOX_LABEL), 70, 10526880);
        }

        if (structuremode == StructureMode.DATA)
        {
            drawString(pMatrixStack, this.font, CUSTOM_DATA_LABEL, this.width / 2 - 153, 110, 10526880);
            this.dataEdit.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        }

        drawString(pMatrixStack, this.font, structuremode.getDisplayName(), this.width / 2 - 153, 174, 10526880);

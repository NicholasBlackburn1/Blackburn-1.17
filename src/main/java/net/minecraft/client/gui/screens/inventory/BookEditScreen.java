...
public class BookEditScreen extends Screen
{
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        if (this.isSigning)
        {
            ...
            this.font.draw(pMatrixStack, formattedcharsequence, (float)(i + 36 + (114 - l) / 2), 50.0F, 0);
        ...
        else
        {
            ...
            {
                this.font.draw(pMatrixStack, bookeditscreen$lineinfo.asComponent, (float)bookeditscreen$lineinfo.x, (float)bookeditscreen$lineinfo.y, -16777216);
            }

            this.m_98138_(bookeditscreen$displaycache.selection);
            this.renderCursor(pMatrixStack, bookeditscreen$displaycache.cursor, bookeditscreen$displaycache.cursorAtEnd);
        }
    ...
    public boolean mouseClicked(double pMouseX, double p_98089_, int pMouseY)
    {
        if (super.mouseClicked(pMouseX, p_98089_, pMouseY))
        {
            return true;
        }
        else
        {
            if (pMouseY == 0)
            {
                ...
                BookEditScreen.DisplayCache bookeditscreen$displaycache = this.getDisplayCache();
                int j = bookeditscreen$displaycache.getIndexAtPosition(this.font, this.convertScreenToLocal(new BookEditScreen.Pos2i((int)pMouseX, (int)p_98089_)));
    ...
    public boolean mouseDragged(double pMouseX, double p_98093_, int pMouseY, double p_98095_, double pButton)
    {
        if (super.mouseDragged(pMouseX, p_98093_, pMouseY, p_98095_, pButton))
        {
            return true;
        }
        else
        {
            ...
            {
                BookEditScreen.DisplayCache bookeditscreen$displaycache = this.getDisplayCache();
                int i = bookeditscreen$displaycache.getIndexAtPosition(this.font, this.convertScreenToLocal(new BookEditScreen.Pos2i((int)pMouseX, (int)p_98093_)));
    ...
    static class DisplayCache
    {
        ...
        {
            int i = BookEditScreen.m_98149_(this.lineStarts, p_98211_);
            int j = i + p_98212_;
            int k;
        ...
        {
            int i = BookEditScreen.m_98149_(this.lineStarts, p_98209_);
            return this.lineStarts[i];
        }

        public int findLineEnd(int p_98219_)
        {
            int i = BookEditScreen.m_98149_(this.lineStarts, p_98219_);

...
public class EnchantmentScreen extends AbstractContainerScreen<EnchantmentMenu>
{
    ...
    protected void renderBg(PoseStack pMatrixStack, float pPartialTicks, int pX, int pY)
    {
        ...
        float f1 = Mth.lerp(pPartialTicks, this.oOpen, this.open);
        ...
        float f3 = Mth.lerp(pPartialTicks, this.oFlip, this.flip) + 0.25F;
        float f4 = Mth.lerp(pPartialTicks, this.oFlip, this.flip) + 0.75F;
        ...
        this.bookModel.renderToBuffer(pMatrixStack, vertexconsumer, 15728880, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        for (int j = 0; j < 3; ++j)
        {
            ...
            if (this.isHovering(60, 14 + 19 * j, 108, 17, (double)pMouseX, (double)pMouseY) && k > 0 && l >= 0 && enchantment != null)
            {

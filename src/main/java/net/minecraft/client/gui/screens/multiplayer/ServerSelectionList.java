...
public class ServerSelectionList extends ObjectSelectionList<ServerSelectionList.Entry>
{
    ...
    public static class LANHeader extends ServerSelectionList.Entry
    {
        ...
        public void render(PoseStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks)
        {
            ...
            this.minecraft.font.draw(pMatrixStack, ServerSelectionList.SCANNING_LABEL, (float)(this.minecraft.screen.width / 2 - this.minecraft.font.width(ServerSelectionList.SCANNING_LABEL) / 2), (float)i, 16777215);
            String s;
            ...
            this.minecraft.font.draw(pMatrixStack, s, (float)(this.minecraft.screen.width / 2 - this.minecraft.font.width(s) / 2), (float)(i + 9), 8421504);
        }
    ...
    public static class NetworkServerEntry extends ServerSelectionList.Entry
    {
        ...
        public void render(PoseStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks)
        {
            this.minecraft.font.draw(pMatrixStack, LAN_SERVER_HEADER, (float)(pLeft + 32 + 3), (float)(pTop + 1), 16777215);
            this.minecraft.font.draw(pMatrixStack, this.serverData.getMotd(), (float)(pLeft + 32 + 3), (float)(pTop + 12), 8421504);

            if (this.minecraft.options.hideServerAddress)
            {
                this.minecraft.font.draw(pMatrixStack, HIDDEN_ADDRESS_TEXT, (float)(pLeft + 32 + 3), (float)(pTop + 12 + 11), 3158064);
            }
            else
            {
                this.minecraft.font.draw(pMatrixStack, this.serverData.getAddress(), (float)(pLeft + 32 + 3), (float)(pTop + 12 + 11), 3158064);
            }
        }
    ...
    public class OnlineServerEntry extends ServerSelectionList.Entry
    {
        ...
        public void render(PoseStack pMatrixStack, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pIsMouseOver, float pPartialTicks)
        {
            ...
            this.minecraft.font.draw(pMatrixStack, this.serverData.name, (float)(pLeft + 32 + 3), (float)(pTop + 1), 16777215);
            List<FormattedCharSequence> list = this.minecraft.font.split(this.serverData.motd, pWidth - 32 - 2);

            for (int i = 0; i < Math.min(list.size(), 2); ++i)
            {
                this.minecraft.font.draw(pMatrixStack, list.get(i), (float)(pLeft + 32 + 3), (float)(pTop + 12 + 9 * i), 8421504);
            }
            ...
            this.minecraft.font.draw(pMatrixStack, component1, (float)(pLeft + pWidth - j - 15 - 2), (float)(pTop + 1), 8421504);
            int k = 0;
            int l;
            ...
            GuiComponent.blit(pMatrixStack, pLeft + pWidth - 15, pTop, (float)(k * 10), (float)(176 + l * 8), 10, 8, 256, 256);
            ...
            if (this.icon == null)
            {
                this.drawIcon(pMatrixStack, pLeft, pTop, ServerSelectionList.ICON_MISSING);
            }
            else
            {
                this.drawIcon(pMatrixStack, pLeft, pTop, this.iconLocation);
            }

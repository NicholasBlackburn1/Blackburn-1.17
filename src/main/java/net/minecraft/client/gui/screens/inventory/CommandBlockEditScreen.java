...
public class CommandBlockEditScreen extends AbstractCommandBlockEditScreen
{
    ...
    protected void init()
    {
        ...
        }).m_168961_(CommandBlockEntity.Mode.values()).displayOnlyValue().withInitialValue(this.mode).create(this.width / 2 - 50 - 100 - 4, 165, 100, 20, new TranslatableComponent("advMode.mode"), (p_169721_, p_169722_) ->
        {
            this.mode = (CommandBlockEntity.Mode)p_169722_;
        }));

...
public class WorldGenSettingsComponent implements Widget
{
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        {
            this.font.drawShadow(pMatrixStack, MAP_FEATURES_INFO, (float)(this.width / 2 - 150), 122.0F, -6250336);
        }
        ...
        {
            this.amplifiedWorldInfo.renderLeftAligned(pMatrixStack, this.typeButton.x + 2, this.typeButton.y + 22, 9, 10526880);
        }
    }

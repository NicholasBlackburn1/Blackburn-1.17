...
public class SocialInteractionsScreen extends Screen
{
    ...
    public boolean mouseClicked(double pMouseX, double p_100754_, int pMouseY)
    {
        if (this.searchBox.isFocused())
        {
            this.searchBox.mouseClicked(pMouseX, p_100754_, pMouseY);
        }

        return super.mouseClicked(pMouseX, p_100754_, pMouseY) || this.socialInteractionsPlayerList.mouseClicked(pMouseX, p_100754_, pMouseY);
    }

...
public class JoinMultiplayerScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        {
            this.editingServer = new ServerData(I18n.m_118938_("selectServer.defaultName"), "", false);
    ...
    public void render(PoseStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
    {
        ...
        this.serverSelectionList.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);
        drawCenteredString(pMatrixStack, this.font, this.title, this.width / 2, 20, 16777215);
        super.render(pMatrixStack, pMouseX, pMouseY, pPartialTicks);

        if (this.toolTip != null)
        {
            this.renderComponentTooltip(pMatrixStack, this.toolTip, pMouseX, pMouseY);
        }
    }

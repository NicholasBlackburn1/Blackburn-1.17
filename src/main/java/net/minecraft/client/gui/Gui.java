...
public class Gui extends GuiComponent {
   ...
   public void render(PoseStack p_93031_, float p_93032_) {
      ...
      if (this.minecraft.gameMode.getPlayerMode() == GameType.SPECTATOR) {
         this.spectatorGui.renderHotbar(p_93031_, p_93032_);
         ...
         for(MobEffectInstance mobeffectinstance : Ordering.natural().reverse().sortedCopy(collection)) {
            ...
            if (mobeffectinstance.showIcon()) {
               ...
               if (mobeffectinstance.isAmbient()) {
                  this.blit(p_93029_, k, l, 165, 166, 24, 24);
               } else {
                  this.blit(p_93029_, k, l, 141, 166, 24, 24);
               ...
               list.add(() -> {
                  ...
                  blit(p_93029_, j1 + 3, k1 + 3, this.getBlitOffset(), 18, 18, textureatlassprite);
               });
            }
         }
